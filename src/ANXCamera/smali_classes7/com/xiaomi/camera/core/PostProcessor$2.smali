...
.method public onParallelDataAvailable(Lcom/xiaomi/camera/core/CaptureData;)V
    ...
    :cond_4
    sget-boolean v4, Lcom/xiaomi/camera/core/PostProcessor;->SKIP_IMAGEPROCESSOR:Z
    ...
    invoke-virtual {v4}, Lcom/xiaomi/camera/core/ImageProcessor;->isBokekMode()Z
    ...
    invoke-virtual {v4}, Lcom/xiaomi/camera/core/ParallelTaskData;->isRequireTuningData()Z
    ...
    invoke-static {v8, v7, v2}, Lcom/xiaomi/camera/base/ImageUtil;->queueImageToPool(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;I)Landroid/media/Image;

    move-result-object v8

    invoke-virtual {v4, v8}, Lcom/xiaomi/camera/core/ParallelTaskData;->setTuningImage(Landroid/media/Image;)V

    :cond_7
    invoke-virtual {v7}, Landroid/media/Image;->close()V

    iget-object v8, p0, Lcom/xiaomi/camera/core/PostProcessor$2;->this$0:Lcom/xiaomi/camera/core/PostProcessor;

    invoke-static {v8}, Lcom/xiaomi/camera/core/PostProcessor;->access$700(Lcom/xiaomi/camera/core/PostProcessor;)Lcom/xiaomi/camera/core/CaptureDataListener;

    move-result-object v8

    invoke-interface {v8, v7}, Lcom/xiaomi/camera/core/CaptureDataListener;->onOriginalImageClosed(Landroid/media/Image;)V
