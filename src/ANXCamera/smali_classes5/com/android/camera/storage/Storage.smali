...
.method public static isUseDocumentMode()Z
    ...
    invoke-virtual {v0}, Lb/c/a/b;->bj()Z
...
.method public static updateImage(Landroid/content/Context;[BZLcom/android/gallery3d/exif/ExifInterface;Landroid/net/Uri;Ljava/lang/String;Landroid/location/Location;IIILjava/lang/String;)Z
    ...
    invoke-static/range {v0 .. v11}, Lcom/android/camera/storage/Storage;->updateImage(Landroid/content/Context;[BZLcom/android/gallery3d/exif/ExifInterface;Landroid/net/Uri;Ljava/lang/String;Landroid/location/Location;IIILjava/lang/String;Z)Z
...
.method public static updateImage(Landroid/content/Context;[BZLcom/android/gallery3d/exif/ExifInterface;Landroid/net/Uri;Ljava/lang/String;Landroid/location/Location;IIILjava/lang/String;Z)Z
    .locals 21
    ...
    const-string v15, "updateImage uri-> "
    ...
    invoke-static {v11, v7}, Lcom/android/camera/FileCompat;->getFileOutputStream(Ljava/lang/String;Z)Ljava/io/OutputStream;
    ...
    invoke-direct {v15, v7}, Ljava/io/BufferedOutputStream;-><init>(Ljava/io/OutputStream;)V
    :try_end_1
    ...
    :try_start_2
    invoke-virtual {v0, v2, v15}, Lcom/android/gallery3d/exif/ExifInterface;->writeExif([BLjava/io/OutputStream;)V
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    invoke-static {v7, v13}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :goto_5
    invoke-virtual {v14, v7}, Ljava/io/BufferedInputStream;->read([B)I
    ...
    invoke-virtual {v15, v7, v8, v13}, Ljava/io/OutputStream;->write([BII)V
    :try_end_3
    ...
    :try_start_4
    invoke-static {v7, v15}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_4
    ...
    :goto_7
    :try_start_5
    invoke-static {v7, v14}, Lcom/android/camera/storage/Storage;->$closeResource(Ljava/lang/Throwable;Ljava/lang/AutoCloseable;)V
    :try_end_5
    ...
    :try_start_c
    invoke-static {v13, v11}, Lcom/android/camera/storage/Storage;->extractDateTaken(Landroid/database/Cursor;Landroid/content/ContentValues;)V
    :try_end_c
    ...
    const-string v8, "renameTo failed, tmpPath = "
    ...
    const-string v11, "updateImage delete old file before renaming -> "
    ...
    invoke-virtual {v0, v6, v3}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Double;)V
    ...
    :try_start_f
    invoke-virtual {v1, v4, v3, v3, v3}, Landroid/content/ContentResolver;->query(Landroid/net/Uri;[Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    invoke-virtual {v1, v4, v0, v3, v3}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    const-string v5, "updateImage update uri "
    ...
    invoke-static {v3, v5, v4}, Lcom/android/camera/storage/Storage;->getMediaUri(Landroid/content/Context;ZLjava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {v4, v0}, Lcom/android/camera/storage/Storage;->renameSdcardFile(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v7, v4}, Lcom/android/camera/storage/Storage;->renameSdcardFile(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {v7}, Lcom/android/camera/storage/Storage;->deleteSdcardFile(Ljava/lang/String;)Z
    ...
    invoke-static {v4}, Lcom/android/camera/FileCompat;->removeDocumentFileForPath(Ljava/lang/String;)V
    ...
    :cond_1a
    invoke-static {v3, v4, v5, v6, v1}, Lcom/android/camera/storage/Storage;->saveToCloudAlbum(Landroid/content/Context;Ljava/lang/String;JZ)V
