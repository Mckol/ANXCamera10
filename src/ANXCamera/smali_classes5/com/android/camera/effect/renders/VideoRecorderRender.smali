...
.method private getSecondRender(IZZZ)Lcom/android/camera/effect/renders/Render;
    ...
    invoke-interface {p4}, Lcom/android/gallery3d/ui/GLCanvas;->getEffectRenderGroup()Lcom/android/camera/effect/renders/RenderGroup;

    move-result-object p4

    sget v0, Lcom/android/camera/effect/FilterInfo;->FILTER_ID_CINEMATIC:I

    invoke-virtual {p4, v0}, Lcom/android/camera/effect/renders/RenderGroup;->getRender(I)Lcom/android/camera/effect/renders/Render;
    ...
    invoke-interface {p4, v1, v0}, Lcom/android/gallery3d/ui/GLCanvas;->prepareEffectRenders(ZI)V
    ...
    invoke-virtual {p1, p4}, Lcom/android/camera/effect/renders/PipeRender;->addRender(Lcom/android/camera/effect/renders/Render;)V
