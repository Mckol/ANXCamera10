...
.method static synthetic a(Ljava/util/concurrent/ConcurrentHashMap;Lcom/android/camera/module/loader/camera2/Camera2Result;)Lio/reactivex/SingleSource;
    .locals 2
...
.method private subscribeCameraResultObservable(Lio/reactivex/Observer;)V
    ...
    sget-object v1, Lcom/android/camera/module/loader/camera2/c;->INSTANCE:Lcom/android/camera/module/loader/camera2/c;
...
.method public declared-synchronized openCamera(IILio/reactivex/Observer;Z)V
    ...
    invoke-virtual {v5}, Lcom/android/camera/data/data/runing/DataItemRunning;->getComponentRunningDualVideo()Lcom/android/camera/data/data/runing/ComponentRunningDualVideo;

    move-result-object v5

    invoke-virtual {v5}, Lcom/android/camera/data/data/runing/ComponentRunningDualVideo;->getIds()Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {p1}, Lcom/android/camera/data/data/runing/ComponentRunningDualVideo;->getIds()Ljava/util/concurrent/ConcurrentHashMap;

    move-result-object p1

    sget-object p2, Lcom/android/camera/module/loader/camera2/Camera2OpenManager;->TAG:Ljava/lang/String;

    new-instance p3, Ljava/lang/StringBuilder;

    invoke-direct {p3}, Ljava/lang/StringBuilder;-><init>()V

    const-string p4, "dual video openCamera: "
    ...
    new-instance p4, Lcom/android/camera/module/loader/camera2/b;

    invoke-direct {p4, p1}, Lcom/android/camera/module/loader/camera2/b;-><init>(Ljava/util/concurrent/ConcurrentHashMap;)V

    invoke-virtual {p3, p4}, Lio/reactivex/Single;->flatMap(Lio/reactivex/functions/Function;)Lio/reactivex/Single;

    move-result-object p1

    new-instance p3, Lcom/android/camera/module/loader/camera2/a;

    invoke-direct {p3, p0}, Lcom/android/camera/module/loader/camera2/a;-><init>(Lcom/android/camera/module/loader/camera2/Camera2OpenManager;)V
