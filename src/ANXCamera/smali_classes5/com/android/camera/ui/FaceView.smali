...
.method private getFacePos(Lcom/android/camera2/CameraHardwareFace;I)V
    ...
    iget v3, p0, Lcom/android/camera/ui/FaceView;->mOrientation:I
    ...
    invoke-virtual {p1, v2, v0, v1, v4}, Landroid/graphics/Rect;->set(IIII)V

    invoke-direct {p0, p1, v3, v5}, Lcom/android/camera/ui/FaceView;->calcFacePos(Landroid/graphics/Rect;FF)Ljava/lang/String;
    ...
    invoke-virtual {p1, v4, v2, v3, v0}, Landroid/graphics/Rect;->set(IIII)V

    invoke-direct {p0, p1, v5, v7}, Lcom/android/camera/ui/FaceView;->calcFacePos(Landroid/graphics/Rect;FF)Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v3, v7}, Lcom/android/camera/ui/FaceView;->calcFacePos(Landroid/graphics/Rect;FF)Ljava/lang/String;
    ...
    invoke-virtual {p1, v0, v2, v1, v4}, Landroid/graphics/Rect;->set(IIII)V
...
.method public setFaces([Lcom/android/camera2/CameraHardwareFace;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    iput v3, p0, Lcom/android/camera/ui/FaceView;->mZoomValue:F

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "setFaces: activeArraySize="
    ...
    iget p2, p0, Lcom/android/camera/ui/FaceView;->mRectState:I

    const/4 p3, 0x4

    if-eq p2, p3, :cond_c

    iget-boolean p2, p0, Lcom/android/camera/ui/FaceView;->mShowGenderAndAge:Z

    if-nez p2, :cond_c

    iget-boolean p2, p0, Lcom/android/camera/ui/FaceView;->mShowMagicMirror:Z
    ...
    invoke-direct {p0, p1, v0}, Lcom/android/camera/ui/FaceView;->getFacePos(Lcom/android/camera2/CameraHardwareFace;I)V
    ...
    invoke-direct {p0, v0, p1}, Lcom/android/camera/ui/FaceView;->setContentDescription(ILjava/lang/String;)V
