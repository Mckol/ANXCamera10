...
.field private final mParallelPerformanceHDREnabled:I

.field private final mParallelPerformanceLLSEnabled:I

.field private final mParallelPerformanceMFNREnabled:I

.field private final mParallelPerformanceSREnabled:I

.field private final mParallelPerformanceSuperNightEnabled:I

.field private final mParallelPerformanceZSLEnabled:I

.field private final mParallelQualityHDREnabled:I

.field private final mParallelQualityLLSEnabled:I

.field private final mParallelQualityMFNREnabled:I

.field private final mParallelQualitySREnabled:I

.field private final mParallelQualitySuperNightEnabled:I

.field private final mParallelQualityZSLEnabled:I
...
.method public constructor <init>()V
    ...
    iput v3, p0, Lcom/android/camera2/CameraConfigs;->mZoomRatio:F

    const/4 v3, 0x0

    iput v3, p0, Lcom/android/camera2/CameraConfigs;->mFlashMode:I

    iput v0, p0, Lcom/android/camera2/CameraConfigs;->mFocusMode:I

    const/high16 v4, -0x40800000    # -1.0f

    iput v4, p0, Lcom/android/camera2/CameraConfigs;->mFocusDistance:F
    ...
    new-instance v5, Lcom/android/camera2/Camera2Proxy$HDRStatus;

    invoke-direct {v5, v3, v3, v3}, Lcom/android/camera2/Camera2Proxy$HDRStatus;-><init>(ZZZ)V

    iput-object v5, p0, Lcom/android/camera2/CameraConfigs;->mHDRStatus:Lcom/android/camera2/Camera2Proxy$HDRStatus;

    iput v3, p0, Lcom/android/camera2/CameraConfigs;->mShotType:I

    const/4 v5, 0x0

    iput-object v5, p0, Lcom/android/camera2/CameraConfigs;->mShotPath:Ljava/util/ArrayDeque;

    iput-object v5, p0, Lcom/android/camera2/CameraConfigs;->mShotPathThumbnail:Ljava/util/ArrayDeque;

    new-instance v6, Ljava/util/ArrayList;

    invoke-direct {v6}, Ljava/util/ArrayList;-><init>()V

    iput-object v6, p0, Lcom/android/camera2/CameraConfigs;->mWaterMarkAppliedList:Ljava/util/List;
    ...
    iput-boolean v3, p0, Lcom/android/camera2/CameraConfigs;->mNeedPausePreview:Z
    ...
    iput v3, p0, Lcom/android/camera2/CameraConfigs;->mAmbilightMode:I
    ...
    iput v6, p0, Lcom/android/camera2/CameraConfigs;->mEyeLightType:I

    iput-object v5, p0, Lcom/android/camera2/CameraConfigs;->mTimeWatermarkValue:Ljava/lang/String;

    iput-object v5, p0, Lcom/android/camera2/CameraConfigs;->mFaceWaterMarkFormat:Ljava/lang/String;

    iput v0, p0, Lcom/android/camera2/CameraConfigs;->mVideoBokehLevelBack:I

    iput v4, p0, Lcom/android/camera2/CameraConfigs;->mVideoBokehLevelFront:F
    ...
    sget v0, Lcom/android/camera/module/loader/camera2/ParallelSnapshotManager;->PARALLEL_PERFORMANCE_FEATURE_SETTING:I

    and-int/lit8 v3, v0, 0x1

    iput v3, p0, Lcom/android/camera2/CameraConfigs;->mParallelPerformanceMFNREnabled:I

    and-int/lit8 v3, v0, 0x2

    shr-int/2addr v3, v1

    iput v3, p0, Lcom/android/camera2/CameraConfigs;->mParallelPerformanceHDREnabled:I

    and-int/lit8 v3, v0, 0x4

    shr-int/2addr v3, v2

    iput v3, p0, Lcom/android/camera2/CameraConfigs;->mParallelPerformanceSuperNightEnabled:I

    and-int/lit8 v3, v0, 0x8

    shr-int/lit8 v3, v3, 0x3

    iput v3, p0, Lcom/android/camera2/CameraConfigs;->mParallelPerformanceLLSEnabled:I

    and-int/lit8 v3, v0, 0x10

    shr-int/lit8 v3, v3, 0x4

    iput v3, p0, Lcom/android/camera2/CameraConfigs;->mParallelPerformanceSREnabled:I

    and-int/lit8 v0, v0, 0x20

    shr-int/lit8 v0, v0, 0x5

    iput v0, p0, Lcom/android/camera2/CameraConfigs;->mParallelPerformanceZSLEnabled:I

    sget v0, Lcom/android/camera/module/loader/camera2/ParallelSnapshotManager;->PARALLEL_QUALITY_FEATURE_SETTING:I

    and-int/lit8 v3, v0, 0x1

    iput v3, p0, Lcom/android/camera2/CameraConfigs;->mParallelQualityMFNREnabled:I

    and-int/lit8 v3, v0, 0x2

    shr-int/lit8 v1, v3, 0x1

    iput v1, p0, Lcom/android/camera2/CameraConfigs;->mParallelQualityHDREnabled:I

    and-int/lit8 v1, v0, 0x4

    shr-int/2addr v1, v2

    iput v1, p0, Lcom/android/camera2/CameraConfigs;->mParallelQualitySuperNightEnabled:I

    and-int/lit8 v1, v0, 0x8

    shr-int/lit8 v1, v1, 0x3

    iput v1, p0, Lcom/android/camera2/CameraConfigs;->mParallelQualityLLSEnabled:I

    and-int/lit8 v1, v0, 0x10

    shr-int/lit8 v1, v1, 0x4

    iput v1, p0, Lcom/android/camera2/CameraConfigs;->mParallelQualitySREnabled:I

    and-int/lit8 v0, v0, 0x20

    shr-int/lit8 v0, v0, 0x5

    iput v0, p0, Lcom/android/camera2/CameraConfigs;->mParallelQualityZSLEnabled:I
...
.method public getHDR10Video()Z
    .locals 0

    iget-boolean p0, p0, Lcom/android/camera2/CameraConfigs;->mHDR10Video:Z
...
.method public setHDR10Video(Z)Z
    .locals 1

    iget-boolean v0, p0, Lcom/android/camera2/CameraConfigs;->mHDR10Video:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, Lcom/android/camera2/CameraConfigs;->mHDR10Video:Z
