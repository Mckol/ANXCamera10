...
public final class b {
    public ArrayList<a> jj = new ArrayList<>();
    public int value;
    ...
    public final boolean equals(Object obj) {
        ...
        b bVar = (b) obj;
        return this.value == bVar.value && HidlSupport.deepEquals(this.jj, bVar.jj);
    }

    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(Integer.valueOf(this.value))), Integer.valueOf(HidlSupport.deepHashCode(this.jj)));
    }
    ...
    public final String toString() {
        return "{" + ".value = " + e.toString(this.value) + ", .fileList = " + this.jj + "}";
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
        ...
        for (int i = 0; i < size; i++) {
            this.jj.get(i).writeEmbeddedToBlob(hwBlob2, (long) (i * 32));
        }
