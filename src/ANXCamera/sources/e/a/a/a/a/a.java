...
public final class a {
    ...
    public final boolean equals(Object obj) {
        ...
        a aVar = (a) obj;
        return HidlSupport.deepEquals(this.name, aVar.name) && this.ij == aVar.ij && this.fileSize == aVar.fileSize;
    }

    public final int hashCode() {
        return Objects.hash(Integer.valueOf(HidlSupport.deepHashCode(this.name)), Integer.valueOf(HidlSupport.deepHashCode(Long.valueOf(this.ij))), Integer.valueOf(HidlSupport.deepHashCode(Long.valueOf(this.fileSize))));
    }
    ...
    public final String toString() {
        return "{" + ".name = " + this.name + ", .mtime = " + this.ij + ", .fileSize = " + this.fileSize + "}";
    }

    public final void writeEmbeddedToBlob(HwBlob hwBlob, long j) {
        hwBlob.putString(0 + j, this.name);
        hwBlob.putInt64(16 + j, this.ij);
