...
public interface c extends a.a.a.a.b {
    ...
    public static final class a implements c {
        ...
        @Override // a.a.a.a.b, e.a.a.a.a.c
    ...
    public static abstract class b extends HwBinder implements c {
        ...
        public final ArrayList<String> interfaceChain() {
            return new ArrayList<>(Arrays.asList(c.kInterfaceName, a.a.a.a.b.kInterfaceName));
        }
        ...
        public void onTransact(int i, HwParcel hwParcel, HwParcel hwParcel2, int i2) throws RemoteException {
            ...
            if (i == 1) {
                ...
                hwParcel.enforceInterface(c.kInterfaceName);
                d f = f(hwParcel.readString(), hwParcel.readString());
                hwParcel2.writeStatus(0);
                f.writeToParcel(hwParcel2);
                hwParcel2.send();
            } else if (i != 4) {
                switch (i) {
                    case 256067662:
