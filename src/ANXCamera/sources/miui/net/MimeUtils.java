...
public class MimeUtils {
    ...
    static {
        ...
        add("application/x-iso9660-image", MistatsConstants.Manual.ISO);
        ...
        add("image/ico", "ico");
        add("image/ief", "ief");
        add(Storage.MIME_JPEG, "jpeg");
        add(Storage.MIME_JPEG, "jpg");
        add(Storage.MIME_JPEG, "jpe");
        add("image/pcx", "pcx");
        add("image/png", "png");
        ...
        add("text/iuls", "uls");
        add("text/mathml", "mml");
        add(HTTP.PLAIN_TEXT_TYPE, "txt");
        add(HTTP.PLAIN_TEXT_TYPE, "asc");
        add(HTTP.PLAIN_TEXT_TYPE, VEEditor.MVConsts.TYPE_TEXT);
        add(HTTP.PLAIN_TEXT_TYPE, "diff");
        add(HTTP.PLAIN_TEXT_TYPE, "po");
    ...
    private static InputStream getContentTypesPropertiesStream() {
        ...
        File file2 = new File(property2, "lib" + File.separator + "content-types.properties");
        if (!file2.exists()) {
            return null;
        }
        try {
