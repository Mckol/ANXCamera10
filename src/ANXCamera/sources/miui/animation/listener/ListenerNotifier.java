...
public class ListenerNotifier {
    ...
    private static BaseNotifier[] sNotifiers = {new BaseNotifier() {
        /* class miui.animation.listener.ListenerNotifier.AnonymousClass1 */
        ...
        /* class miui.animation.listener.ListenerNotifier.AnonymousClass2 */
        ...
        /* class miui.animation.listener.ListenerNotifier.AnonymousClass3 */
        ...
        /* class miui.animation.listener.ListenerNotifier.AnonymousClass4 */
        ...
        /* class miui.animation.listener.ListenerNotifier.AnonymousClass5 */
        ...
        /* class miui.animation.listener.ListenerNotifier.AnonymousClass6 */
        ...
        /* class miui.animation.listener.ListenerNotifier.AnonymousClass7 */
        ...
        /* class miui.animation.listener.ListenerNotifier.AnonymousClass8 */
        ...
        /* class miui.animation.listener.ListenerNotifier.AnonymousClass9 */
    ...
    public static abstract class BaseNotifier {
        ...
        /* access modifiers changed from: package-private */
        public abstract void doNotify(ListenerNode listenerNode, Object obj, List<UpdateInfo> list);
    ...
    private void notifyByType(int i, Object obj, UpdateInfo updateInfo, Collection<UpdateInfo> collection) {
        if (getNodeCount() != 0) {
            ...
            if (pendingNotify == null) {
                ...
                for (PendingNotify pendingNotify3 : this.mPendingList) {
                    if (pendingNotify3.isSame(obj, i)) {
                        return;
                    }
                }
