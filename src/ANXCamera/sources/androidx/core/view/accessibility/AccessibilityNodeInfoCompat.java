            ...
            if (cls != null) {
                try {
                    ...
                    try {
                        ...
                        Log.e(TAG, "Failed to execute command with argument class ViewCommandArgument: " + r1, e2);
                        return this.mCommand.perform(view, commandArguments);
                    }
                } catch (Exception e4) {
                    e2 = e4;
                    Class<? extends AccessibilityViewCommand.CommandArguments> cls22 = this.mViewCommandArgumentClass;
