        ...
        if (appCompatCallback2 != null && !this.mIsDestroyed) {
            ...
            if (actionMode == null) {
                ...
                if (this.mActionModeView == null) {
                    if (this.mIsFloating) {
                        ...
                        if (typedValue.resourceId != 0) {
                            ...
                            ContextThemeWrapper contextThemeWrapper2 = new ContextThemeWrapper(this.mContext, 0);
                ...
                if (this.mActionModeView != null) {
                    ...
                    StandaloneActionMode standaloneActionMode = new StandaloneActionMode(context, actionBarContextView, callback, z);
