        ...
        if (!shouldLayout(this.mNavButtonView)) {
            ...
            if (!shouldLayout || shouldLayout2) {
                ...
                if (i17 != 48) {
                    i18 = max;
                    z3 = shouldLayout2;
                    i19 = getPaddingTop() + ((ViewGroup.MarginLayoutParams) layoutParams3).topMargin + this.mTitleMarginTop;
                } else if (i17 != 80) {
                    ...
                    i18 = max;
                    z3 = shouldLayout2;
                    i19 = (((height - paddingBottom) - ((ViewGroup.MarginLayoutParams) layoutParams4).bottomMargin) - this.mTitleMarginBottom) - i8;
                }
                if (!z4) {
                    if (z2) {
                        i22 = this.mTitleMarginStart;
                        c2 = 1;
                    } else {
                        c2 = 1;
                        i22 = 0;
                    ...
                    if (shouldLayout) {
                        ...
                        i19 = measuredHeight + ((ViewGroup.MarginLayoutParams) ((LayoutParams) this.mTitleTextView.getLayoutParams())).bottomMargin;
                    } else {
                        i23 = min2;
                    }
                    if (z3) {
                        LayoutParams layoutParams5 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                        int i33 = i19 + ((ViewGroup.MarginLayoutParams) layoutParams5).topMargin;
                    ...
                    i12 = 0;
                    int i35 = (z2 ? this.mTitleMarginStart : 0) - iArr[0];
                    max = i18 + Math.max(0, i35);
                    ...
                    if (shouldLayout) {
                        ...
                        i19 = measuredHeight2 + ((ViewGroup.MarginLayoutParams) ((LayoutParams) this.mTitleTextView.getLayoutParams())).bottomMargin;
                    } else {
                        i20 = max;
                    }
                    if (z3) {
                        LayoutParams layoutParams6 = (LayoutParams) this.mSubtitleTextView.getLayoutParams();
                        int i36 = i19 + ((ViewGroup.MarginLayoutParams) layoutParams6).topMargin;
            ...
            i16 = (i11 + (((i9 - i11) - i7) / 2)) - (viewListMeasuredWidth2 / 2);
            int i382 = viewListMeasuredWidth2 + i16;
            if (i16 >= i13) {
            }
            size3 = this.mTempViews.size();
            while (i12 < size3) {
