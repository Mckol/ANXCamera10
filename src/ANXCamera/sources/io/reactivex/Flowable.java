...
public abstract class Flowable<T> implements Publisher<T> {
    ...
    public final <R> R as(@NonNull FlowableConverter<T, ? extends R> flowableConverter) {
        ...
        return (R) flowableConverter.apply(this);
    }
    ...
    /* JADX DEBUG: Type inference failed for r1v1. Raw type applied. Possible types: io.reactivex.Flowable<U extends java.util.Collection<? super T>>, io.reactivex.Flowable<java.util.List<T>> */
    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    ...
    /* JADX DEBUG: Type inference failed for r8v1. Raw type applied. Possible types: io.reactivex.Flowable<U extends java.util.Collection<? super T>>, io.reactivex.Flowable<java.util.List<T>> */
    @SchedulerSupport(SchedulerSupport.COMPUTATION)
    @BackpressureSupport(BackpressureKind.ERROR)
    @CheckReturnValue
    ...
    /* JADX DEBUG: Type inference failed for r1v1. Raw type applied. Possible types: io.reactivex.Flowable<R>, io.reactivex.Flowable<U> */
    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX DEBUG: Type inference failed for r7v1. Raw type applied. Possible types: io.reactivex.Flowable<R>, io.reactivex.Flowable<V> */
    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    ...
    /* JADX DEBUG: Type inference failed for r2v1. Raw type applied. Possible types: io.reactivex.Flowable<io.reactivex.flowables.GroupedFlowable<K, V>>, io.reactivex.Flowable<io.reactivex.flowables.GroupedFlowable<K, T>> */
    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
