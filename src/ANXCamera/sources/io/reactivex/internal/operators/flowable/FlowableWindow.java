...
public final class FlowableWindow<T> extends AbstractFlowableWithUpstream<T, Flowable<T>> {
    ...
    public void subscribeActual(Subscriber<? super Flowable<T>> subscriber) {
        ...
        if (j == j2) {
            ...
            this.source.subscribe((FlowableSubscriber) new WindowSkipSubscriber(subscriber, j2, j, this.bufferSize));
        } else {
            this.source.subscribe((FlowableSubscriber) new WindowOverlapSubscriber(subscriber, j2, j, this.bufferSize));
        }
    }
}
