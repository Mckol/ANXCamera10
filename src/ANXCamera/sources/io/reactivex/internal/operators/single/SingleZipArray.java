...
public final class SingleZipArray<T, R> extends Single<R> {
    ...
    final class SingletonArrayFunc implements Function<T, R> {
        ...
        public R apply(T t) throws Exception {
            R r = (R) SingleZipArray.this.zipper.apply(new Object[]{t});
            ObjectHelper.requireNonNull(r, "The zipper returned a null value");
            return r;
        }
    }
    ...
    static final class ZipCoordinator<T, R> extends AtomicInteger implements Disposable {
        ...
        /* JADX DEBUG: Type inference failed for r3v1. Raw type applied. Possible types: ? super java.lang.Object[] */
        /* access modifiers changed from: package-private */
