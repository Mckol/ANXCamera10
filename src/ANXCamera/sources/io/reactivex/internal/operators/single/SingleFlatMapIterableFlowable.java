...
public final class SingleFlatMapIterableFlowable<T, R> extends Flowable<R> {
    ...
    static final class FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R> implements SingleObserver<T> {
        ...
        public void cancel() {
            this.cancelled = true;
            this.f785d.dispose();
            this.f785d = DisposableHelper.DISPOSED;
        }
                            ...
                            while (j2 != j) {
                                if (!this.cancelled) {
                                    try {
                                        ...
                                        ObjectHelper.requireNonNull(obj, "The iterator returned a null value");
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f785d, disposable)) {
                this.f785d = disposable;
