...
public final class ObservableFlattenIterable<T, R> extends AbstractObservableWithUpstream<T, R> {
    ...
    static final class FlattenIterableObserver<T, R> implements Observer<T>, Disposable {
        ...
        public void dispose() {
            this.f767d.dispose();
            this.f767d = DisposableHelper.DISPOSED;
        }

        @Override // io.reactivex.disposables.Disposable
        public boolean isDisposed() {
            return this.f767d.isDisposed();
        }

        @Override // io.reactivex.Observer
        public void onComplete() {
            Disposable disposable = this.f767d;
            DisposableHelper disposableHelper = DisposableHelper.DISPOSED;
            if (disposable != disposableHelper) {
                this.f767d = disposableHelper;
        ...
        public void onNext(T t) {
            if (this.f767d != DisposableHelper.DISPOSED) {
                try {
        ...
        public void onSubscribe(Disposable disposable) {
            if (DisposableHelper.validate(this.f767d, disposable)) {
                this.f767d = disposable;
