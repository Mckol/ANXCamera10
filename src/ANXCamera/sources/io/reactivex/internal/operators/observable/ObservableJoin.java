...
public final class ObservableJoin<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AbstractObservableWithUpstream<TLeft, R> {
    ...
    static final class JoinDisposable<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AtomicInteger implements Disposable, ObservableGroupJoin.JoinSupport {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r6v11, resolved type: java.util.Map<java.lang.Integer, TLeft> */
                    ...
                    if (z && z2) {
                        ...
                        if (num == LEFT_VALUE) {
                            ...
                            try {
                                ...
                                for (TRight tright : this.rights.values()) {
                                    try {
                                        ...
                                        ObjectHelper.requireNonNull(obj, "The resultSelector returned a null value");
                                        observer.onNext(obj);
                                    } catch (Throwable th) {
                            ...
                            try {
                                ...
                                ObjectHelper.requireNonNull(apply2, "The rightEnd returned a null ObservableSource");
                                ...
                                for (TLeft tleft : this.lefts.values()) {
                                    try {
                                        ...
                                        ObjectHelper.requireNonNull(obj2, "The resultSelector returned a null value");
