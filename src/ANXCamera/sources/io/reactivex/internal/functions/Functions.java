...
public final class Functions {
    ...
    public static final class Array3Func<T1, T2, T3, R> implements Function<Object[], R> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r3v2, resolved type: io.reactivex.functions.Function3<T1, T2, T3, R> */
    ...
    public static final class Array4Func<T1, T2, T3, T4, R> implements Function<Object[], R> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r4v2, resolved type: io.reactivex.functions.Function4<T1, T2, T3, T4, R> */
        /* JADX WARN: Multi-variable type inference failed */
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 4) {
    ...
    public static final class Array5Func<T1, T2, T3, T4, T5, R> implements Function<Object[], R> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: io.reactivex.functions.Function5<T1, T2, T3, T4, T5, R> */
        /* JADX WARN: Multi-variable type inference failed */
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 5) {
    ...
    public static final class Array6Func<T1, T2, T3, T4, T5, T6, R> implements Function<Object[], R> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: io.reactivex.functions.Function6<T1, T2, T3, T4, T5, T6, R> */
        /* JADX WARN: Multi-variable type inference failed */
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 6) {
    ...
    public static final class Array7Func<T1, T2, T3, T4, T5, T6, T7, R> implements Function<Object[], R> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: io.reactivex.functions.Function7<T1, T2, T3, T4, T5, T6, T7, R> */
        /* JADX WARN: Multi-variable type inference failed */
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 7) {
    ...
    public static final class Array8Func<T1, T2, T3, T4, T5, T6, T7, T8, R> implements Function<Object[], R> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: io.reactivex.functions.Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> */
        /* JADX WARN: Multi-variable type inference failed */
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 8) {
    ...
    public static final class Array9Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> implements Function<Object[], R> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r2v0, resolved type: io.reactivex.functions.Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> */
        /* JADX WARN: Multi-variable type inference failed */
        public R apply(Object[] objArr) throws Exception {
            if (objArr.length == 9) {
    ...
    public static final class ToMapKeySelector<K, T> implements BiConsumer<Map<K, T>, T> {
        ...
        /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: java.util.Map<K, T> */
        /* JADX WARN: Multi-variable type inference failed */
