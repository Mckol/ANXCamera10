...
public abstract class Single<T> implements SingleSource<T> {
    ...
    public final <R> R as(@NonNull SingleConverter<T, ? extends R> singleConverter) {
        ...
        return (R) singleConverter.apply(this);
    }
    ...
    /* JADX DEBUG: Type inference failed for r1v1. Raw type applied. Possible types: io.reactivex.Single<R>, io.reactivex.Single<U> */
    @SchedulerSupport("none")
    @CheckReturnValue
