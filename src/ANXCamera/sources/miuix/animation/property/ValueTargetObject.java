...
public class ValueTargetObject {
    ...
    public <T> T getPropertyValue(String str, Class<T> cls) {
        Object realObject = getRealObject();
        if (this.mTempObj == null && realObject != null) {
    ...
    public boolean isValid() {
        return (this.mTempObj == null && getRealObject() == null) ? false : true;
    }

    /* JADX DEBUG: Multi-variable search result rejected for r6v0, resolved type: miuix.animation.property.ValueTargetObject */
