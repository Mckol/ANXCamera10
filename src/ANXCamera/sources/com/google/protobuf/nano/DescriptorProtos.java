            ...
            if (uninterpretedOptionArr != null && uninterpretedOptionArr.length > 0) {
                ...
                while (true) {
                    ...
                    if (uninterpretedOption2 != null) {
                        computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(Recorder.ErrorCode.UNKNOWN, uninterpretedOption2);
                    }
                    i++;
                }
            }
        ...
        public void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
            ...
            if (uninterpretedOptionArr != null && uninterpretedOptionArr.length > 0) {
                ...
                while (true) {
                    ...
                    UninterpretedOption uninterpretedOption2 = uninterpretedOptionArr2[i];
                    if (uninterpretedOption2 != null) {
                        codedOutputByteBufferNano.writeMessage(Recorder.ErrorCode.UNKNOWN, uninterpretedOption2);
                    }
                    i++;
                }
            }
