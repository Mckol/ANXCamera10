...
public class EffectSDKUtils {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v6, resolved type: java.io.FileOutputStream */
    ...
    private static void copyFile(Context context, String str, String str2) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                open = new FileOutputStream(new File(str3 + "/" + getFileName(str)));
            } catch (Throwable th2) {
                th = th2;
                try {
