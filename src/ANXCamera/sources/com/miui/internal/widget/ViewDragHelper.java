...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new Interpolator() {
        /* class com.miui.internal.widget.ViewDragHelper.AnonymousClass1 */
    ...
    private final Runnable mSetIdleRunnable = new Runnable() {
        /* class com.miui.internal.widget.ViewDragHelper.AnonymousClass2 */
    ...
    private boolean checkTouchSlop(View view, float f, float f2) {
        ...
        if (!z || !z2) {
            return z ? Math.abs(f2) < ((float) this.mTouchSlop) && Math.abs(f) > ((float) this.mTouchSlop) : z2 && Math.abs(f) < ((float) this.mTouchSlop) && Math.abs(f2) > ((float) this.mTouchSlop);
        }
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
        ...
        } else if (isValidPointerForActionMove(this.mActivePointerId) && (findPointerIndex = motionEvent.findPointerIndex(this.mActivePointerId)) >= 0 && findPointerIndex < motionEvent.getPointerCount()) {
            ...
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    ...
                    if (actionMasked == 5) {
                        ...
                        } else if (i2 == 2 && (findTopChildUnder = findTopChildUnder((int) x2, (int) y2)) == this.mCapturedView) {
