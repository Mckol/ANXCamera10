...
public class ListMenuPresenterHelper {
    public static void calcAndSetPadding(Context context, int i, int i2, View view) {
        ...
        if (i2 == i - 1) {
            i3 = context.getResources().getDimensionPixelSize(R.dimen.list_menu_item_padding_small);
            i4 = context.getResources().getDimensionPixelSize(R.dimen.list_menu_item_padding_large);
        } else {
            i3 = context.getResources().getDimensionPixelSize(R.dimen.list_menu_item_padding_small);
