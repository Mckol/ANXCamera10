...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView {
    ...
    private void insertCheckBox() {
        this.mCheckBox = (CheckBox) getInflater().inflate(com.miui.internal.R.layout.list_menu_item_checkbox, (ViewGroup) this, false);
        addView(this.mCheckBox);
    }

    private void insertIconView() {
        this.mIconView = (ImageView) getInflater().inflate(com.miui.internal.R.layout.list_menu_item_icon, (ViewGroup) this, false);
        addView(this.mIconView, 0);
    }

    private void insertRadioButton() {
        this.mRadioButton = (RadioButton) getInflater().inflate(com.miui.internal.R.layout.list_menu_item_radio, (ViewGroup) this, false);
