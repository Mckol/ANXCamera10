        ...
        try {
            ...
            if (str.hashCode() == 2043549244) {
                if (str.equals("vesdk_log_command")) {
                    ...
                    TESpdLogManager.InfoLevel infoLevel2 = (string3.hashCode() == 68 && string3.equals(Field.DOUBLE_SIGNATURE_PRIMITIVE)) ? false : true ? TESpdLogManager.InfoLevel.LEVEL3 : TESpdLogManager.InfoLevel.LEVEL0;
