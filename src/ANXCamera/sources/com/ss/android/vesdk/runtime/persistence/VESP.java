...
public class VESP {
    ...
    public <T> T get(@NonNull String str, @NonNull T t) {
        return t instanceof String ? (T) this.sharedPreferences.getString(str, t) : t instanceof Integer ? (T) Integer.valueOf(this.sharedPreferences.getInt(str, t.intValue())) : t instanceof Boolean ? (T) Boolean.valueOf(this.sharedPreferences.getBoolean(str, t.booleanValue())) : t instanceof Float ? (T) Float.valueOf(this.sharedPreferences.getFloat(str, t.floatValue())) : t instanceof Long ? (T) Long.valueOf(this.sharedPreferences.getLong(str, t.longValue())) : (T) this.sharedPreferences.getString(str, null);
    }
