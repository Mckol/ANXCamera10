...
public enum VEVideoEncodeProfile implements Parcelable {
    ...
    public static VEVideoEncodeProfile valueOfString(String str) {
        ...
        return !TextUtils.isEmpty(str) ? "baseline".equals(str) ? ENCODE_PROFILE_BASELINE : a.f413d.equals(str) ? ENCODE_PROFILE_MAIN : "high".equals(str) ? ENCODE_PROFILE_HIGH : vEVideoEncodeProfile : vEVideoEncodeProfile;
    }
