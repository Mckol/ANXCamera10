...
public class VEEditor implements SurfaceTexture.OnFrameAvailableListener, LifecycleObserver {
            ...
            public int onOpenGLDrawAfter(int i, double d2) {
                ...
                if (VEEditor.this.miFrameCount == 30) {
                    ...
                    if (VEEditor.this.mlLastTimeMS != VEEditor.this.mlCurTimeMS) {
                        ...
                        VELogUtil.d(VEEditor.TAG, "Render FPS = " + f);
                        VEEditor vEEditor = VEEditor.this;
    ...
    private int setColorFilter(String str, String str2, float f, float f2, boolean z) {
        ...
        this.mVideoEditor.setFilterParam(this.mColorFilterIndex, FILTER_POSITION, str4 + f);
        VEKeyValue vEKeyValue = new VEKeyValue();
        if (!TextUtils.isEmpty(str)) {
            String[] split = str.split(File.separator);
            if (split.length > 0) {
    ...
    public synchronized int addAudioTrack(String str, int i, int i2, int i3, int i4, boolean z) {
        synchronized (this) {
            ...
            return this.mTrackIndexManager.addTrack(1, this.mVideoEditor.addAudioTrack(str, i3, i4, i, i2, z));
        }
    }
    ...
    public synchronized int addExtRes(String str, int i, int i2, int i3, int i4, float f, float f2, float f3, float f4) {
        ...
        if (i <= i2 && i >= 0) {
            if (!TextUtils.isEmpty(str)) {
                ...
                return this.mVideoEditor.addSticker(new String[]{str}, null, new int[]{i}, new int[]{i2}, new int[]{i3}, new int[]{i4}, (double) f3, (double) f4, (double) f, (double) f2);
            }
        }
        return -100;
    }
    ...
    public synchronized int addSlowMotionEffect(int i, int i2, int i3, int i4, float f, float f2) {
        synchronized (this) {
            ...
            if (pauseSync == 0 || pauseSync == -101) {
                ...
                TEInterface tEInterface2 = this.mVideoEditor;
                int i6 = addFilters[0];
                tEInterface2.setFilterParam(i6, "timeEffect slow motion speed", "" + f);
                TEInterface tEInterface3 = this.mVideoEditor;
                int i7 = addFilters[0];
                tEInterface3.setFilterParam(i7, "timeEffect fast motion speed", "" + f2);
                this.mVideoEditor.createTimeline();
                VEKeyValue vEKeyValue = new VEKeyValue();
    ...
    public synchronized int deleteAudioTrack(int i) {
        synchronized (this) {
            ...
            return this.mVideoEditor.deleteAudioTrack(nativeTrackIndex);
        }
    }
    ...
    public synchronized int updateAudioTrack(int i, int i2, int i3, int i4, int i5, boolean z) {
        synchronized (this) {
            ...
            return this.mVideoEditor.updateAudioTrack(this.mTrackIndexManager.getNativeTrackIndex(1, i), i4, i5, i2, i3, z);
        }
    }
