...
public class CameraInstance {
    ...
    public Rect calculateTapArea(float f, float f2, float f3, int i) {
        ...
        int i2 = intValue / 2;
        int clamp = clamp((((int) (f * 2000.0f)) - 1000) - i2, NotificationManagerCompat.IMPORTANCE_UNSPECIFIED, 1000);
        int clamp2 = clamp((((int) (f2 * 2000.0f)) - 1000) - i2, NotificationManagerCompat.IMPORTANCE_UNSPECIFIED, 1000);
