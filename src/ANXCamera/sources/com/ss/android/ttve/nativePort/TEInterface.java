...
public final class TEInterface extends TENativeServiceBase {
    ...
    public int processTouchDownEvent(float f, float f2, VEGestureType vEGestureType) {
        long j = this.mNative;
        return j == 0 ? VEResult.TER_INVALID_HANDLER : nativeProcessTouchDownEvent(j, f, f2, vEGestureType.ordinal());
    }
    ...
    public int processTouchUpEvent(float f, float f2, VEGestureType vEGestureType) {
        long j = this.mNative;
        return j == 0 ? VEResult.TER_INVALID_HANDLER : nativeProcessTouchUpEvent(j, f, f2, vEGestureType.ordinal());
    }
