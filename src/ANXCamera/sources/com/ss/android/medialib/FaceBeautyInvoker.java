...
public class FaceBeautyInvoker implements MessageCenter.Listener {
    ...
    private native void nativeOnSwapGlBuffers(long j);
    ...
    public int initAudioPlayer(Context context, String str, long j, boolean z, boolean z2) {
        ...
        synchronized (this) {
            ...
            return nativeInitAudioPlayer(this.mHandler, str, ((Integer) pair.first).intValue(), ((Integer) pair.second).intValue(), j, z);
        }
    }
    ...
    public int startRecord(double d2, boolean z, float f, int i, int i2) {
        int i3;
