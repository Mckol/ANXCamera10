...
public final class QMediaStoreUriLoader<DataT> implements ModelLoader<Uri, DataT> {
    ...
    public static final class QMediaStoreUriFetcher<DataT> implements DataFetcher<DataT> {
        ...
        /* JADX DEBUG: Type inference failed for r0v3. Raw type applied. Possible types: com.bumptech.glide.load.data.DataFetcher<Data>, com.bumptech.glide.load.data.DataFetcher<DataT> */
        @Nullable
