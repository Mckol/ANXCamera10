...
public class AvatarContentProvider extends ContentProvider {
    ...
    private static final String f249a = "AvatarContentProvider";

    /* renamed from: b  reason: collision with root package name */
    private DBHelper f250b;
    ...
    public int delete(@NonNull Uri uri, @Nullable String str, @Nullable String[] strArr) {
        ...
        synchronized (this.f250b) {
            ...
            try {
                sQLiteDatabase = this.f250b.getWritableDatabase();
        ...
        synchronized (this.f250b) {
            ...
            try {
                ...
                try {
                    ...
                    sQLiteDatabase.setTransactionSuccessful();
                    if (j < 0) {
                        Log.e(f249a, "insert err:rowId=" + j);
                    } else {
    ...
    public boolean onCreate() {
        this.f250b = new DBHelper(getContext());
        return true;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] strArr, @Nullable String str, @Nullable String[] strArr2, @Nullable String str2) {
        ...
        synchronized (this.f250b) {
            cursor = null;
            try {
                sQLiteDatabase = this.f250b.getReadableDatabase();
                try {
                    sQLiteDatabase.beginTransaction();
                    LOG.d("DELETE", "URI = " + uri);
                    if (AvatarProfile.sUriMatcher.match(uri) == 1) {
                    ...
                    sQLiteDatabase.setTransactionSuccessful();
                    if (cursor == null) {
                        Log.e(f249a, "query err:retCursor==null");
                    } else {
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String str, @Nullable String[] strArr) {
        ...
        synchronized (this.f250b) {
            SQLiteDatabase sQLiteDatabase = null;
            try {
                SQLiteDatabase writableDatabase = this.f250b.getWritableDatabase();
