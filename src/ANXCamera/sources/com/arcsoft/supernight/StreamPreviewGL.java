...
public class StreamPreviewGL extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    private void b() {
        ...
        GLES20.glGenTextures(2, this.f368e, 0);
        GLES20.glBindTexture(3553, this.f368e[0]);
        GLES20.glTexParameterf(3553, 10241, 9728.0f);
        GLES20.glTexParameterf(3553, 10240, 9729.0f);
        GLES20.glTexParameterf(3553, 10242, 33071.0f);
        GLES20.glTexParameterf(3553, 10243, 33071.0f);
        GLES20.glBindTexture(3553, this.f368e[1]);
        GLES20.glTexParameterf(3553, 10241, 9728.0f);
        GLES20.glTexParameterf(3553, 10240, 9729.0f);
        GLES20.glTexParameterf(3553, 10242, 33071.0f);
        GLES20.glTexParameterf(3553, 10243, 33071.0f);
    ...
    private void c() {
        this.f = ShaderUtils.loadFromAssetsFile("arcsoft/vertex.sh", this.f364a.getResources());
        this.g = ShaderUtils.loadFromAssetsFile("arcsoft/frag.sh", this.f364a.getResources());
    ...
    private void i() {
        if (this.H != null) {
            ...
            GLES20.glTexImage2D(3553, 0, 6409, this.f366c, this.f367d, 0, 6409, 5121, this.H[0].position(0));
            GLES20.glUniform1i(this.k, 0);
            GLES20.glActiveTexture(33985);
            GLES20.glBindTexture(3553, this.f368e[1]);
            GLES20.glPixelStorei(3314, this.G / 2);
            GLES20.glTexImage2D(3553, 0, 6410, this.f366c / 2, this.f367d / 2, 0, 6410, 5121, this.H[1].position(0));
    ...
    public void setPreviewSize(int i2, int i3) {
        if (this.f366c != i2 || this.f367d != i3) {
            this.f366c = i2;
            this.f367d = i3;
            this.H = null;
        }
