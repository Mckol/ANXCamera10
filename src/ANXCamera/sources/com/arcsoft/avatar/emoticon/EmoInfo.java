...
public class EmoInfo {
    ...
    private static final String f33a = "EmoInfo";

    /* renamed from: b  reason: collision with root package name */
    private boolean f34b = true;
    ...
    public String toString() {
        String str = "emoName = " + this.f35c + ", emoMaxCount = " + this.f + "\n";
