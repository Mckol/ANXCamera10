...
public class ExtraSceneEngine {
    ...
    private static final String f39a = "ExtraSceneEngine";

    /* renamed from: b  reason: collision with root package name */
    private static final String f40b = "extraScene.xml";

    /* renamed from: c  reason: collision with root package name */
    private static final String f41c = "info";

    /* renamed from: d  reason: collision with root package name */
    private static final String f42d = "name";

    /* renamed from: e  reason: collision with root package name */
    private static final String f43e = "headwear";
    ...
    public void checkExtraScene(AvatarConfig.ASAvatarProcessInfo aSAvatarProcessInfo) {
        if (aSAvatarProcessInfo == null) {
            LOG.d(f39a, "info is null");
        } else if (this.Q == null) {
            LOG.d(f39a, "mConfigValue is null");
        } else {
            ...
            if (this.Q.configHeadwearStyleID != -1) {
                ...
                if (extraSceneInfo == null) {
                    LOG.d(f39a, "mExtraSceneInfo is null");
                    return;
                }
