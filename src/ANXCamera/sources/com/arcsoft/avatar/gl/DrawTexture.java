...
public class DrawTexture {
    ...
    private void a(boolean z) {
        ...
        this.f63e = GLES30.glGetAttribLocation(this.f62d, "aPosition");
        GLES30.glBindBuffer(34962, this.g[0]);
        GLES30.glBufferData(34962, this.k.length * 4, asFloatBuffer, 35044);
        GLES30.glEnableVertexAttribArray(this.f63e);
        GLES30.glVertexAttribPointer(this.f63e, 2, 5126, false, 8, 0);
        ...
        this.i.position(0);
        this.j = false;
        this.f = GLES30.glGetAttribLocation(this.f62d, "arc_tex_coord");
    ...
    public void DrawSurfaceWithTex(int i2) {
        GLES30.glUseProgram(this.f62d);
        GLES30.glBindVertexArray(this.h[0]);
        GLES30.glActiveTexture(33984);
        GLES30.glBindTexture(3553, i2);
        GLES30.glUniform1i(this.f61c, 0);
    ...
    public void initGLFun(boolean z) {
        ...
        this.f62d = GLES30.glCreateProgram();
        int i2 = this.f62d;
        if (i2 != 0) {
            GLES30.glAttachShader(i2, glCreateShader);
            GLES30.glAttachShader(this.f62d, glCreateShader2);
            GLES30.glLinkProgram(this.f62d);
            int[] iArr3 = new int[1];
            GLES30.glGetProgramiv(this.f62d, 35714, iArr3, 0);
            if (iArr3[0] == 0) {
                this.f62d = 0;
            }
        }
        a(z);
        this.f61c = GLES30.glGetUniformLocation(this.f62d, "sTexture");
    }
