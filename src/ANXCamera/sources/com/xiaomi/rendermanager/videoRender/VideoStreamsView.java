...
public class VideoStreamsView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    public int CalcRatioViewPort(int i, int i2, int i3) {
        ...
        float f = (float) ((((double) i5) * 1.0d) / ((double) i6));
        int i7 = this._oriViewHeight;
        float f2 = (float) ((((double) i4) * 1.0d) / ((double) i7));
        if (f > f2) {
        ...
        float f3 = ((float) i8) / ((float) i9);
        Log.i(TAG, "VideoStreamView: VideoStreamView opengl setting first calculate: " + this._RatioX + " _RatioY:" + this._RatioY + " _RatioWidth:" + this._RatioWidth + " _RatioHeight:" + this._RatioHeight + " screen height:" + this._oriViewHeight + " screen Width:" + this._oriViewWidth + " frame height:" + i2 + " frame width:" + i + " showRatio:" + f3 + " screen:" + i8 + " showsize:" + i9 + " wRatio:" + f + " hRatio:" + f2 + " rotateImageWidth:" + i5 + " rotateImageHeight:" + i4);
