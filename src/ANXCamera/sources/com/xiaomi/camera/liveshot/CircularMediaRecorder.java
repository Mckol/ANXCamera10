...
public class CircularMediaRecorder {
    ...
    private static final String TAG = "CircularMediaRecorder";
    ...
    public CircularMediaRecorder(int i, int i2, EGLContext eGLContext, boolean z, Queue<LivePhotoResult> queue) {
        this.mCircularVideoEncoder = new CircularVideoEncoder(createVideoFormat(i, i2), eGLContext, CAPTURE_DURATION_IN_MICROSECOND, 1000000, queue);
        if (z) {
            this.mCircularAudioEncoder = new CircularAudioEncoder(createAudioFormat(44100, 1), CAPTURE_DURATION_IN_MICROSECOND, 1000000, null);
        } else {
