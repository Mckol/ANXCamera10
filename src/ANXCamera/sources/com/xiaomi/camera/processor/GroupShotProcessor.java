...
public class GroupShotProcessor implements AlgoProcessor {
    ...
    public void doProcess(@NonNull CaptureData captureData, ProcessResultListener processResultListener, TaskSession taskSession) {
        ...
        CaptureData.CaptureDataBean captureDataBean2 = new CaptureData.CaptureDataBean(captureData.getStreamNum(), captureData.isRequireTuningData(), captureData.isSatFusionShot());
        CaptureData.CaptureDataBean captureDataBean3 = captureDataBeanList.get(captureDataBeanList.size() - 1);
        ...
        if (captureData.isRequireTuningData()) {
            captureDataBean2.setImage(captureDataBean3.getTuningImage(), 2);
        }
        if (captureData.isSatFusionShot()) {
            captureDataBean2.setImage(captureDataBean3.getSubImage(), 1);
        }
