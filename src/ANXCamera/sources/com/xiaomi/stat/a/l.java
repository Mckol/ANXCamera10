...
public class l {
    ...
    public static class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static final int f451a = 30;
        ...
        /* renamed from: b  reason: collision with root package name */
        public static final String f452b = "e";

        /* renamed from: c  reason: collision with root package name */
        public static final String f453c = "eg";

        /* renamed from: d  reason: collision with root package name */
        public static final String f454d = "tp";

        /* renamed from: e  reason: collision with root package name */
        public static final String f455e = "ts";
    ...
    public static l a(int i, int i2, long j, long j2) {
        l lVar = new l();
        lVar.f446a = "mistat_page_monitor";
        lVar.f447b = a.h;
        lVar.f448c = "track";
        lVar.f450e = r.b();
        aj ajVar = new aj();
    ...
    public static l a(MiStatParams miStatParams, boolean z, String str) {
        l lVar = new l();
        lVar.f448c = "profile_set";
        lVar.f450e = r.b();
        lVar.f449d = new aj(miStatParams);
        if (b.e()) {
            lVar.g = !z;
        } else {
            lVar.g = false;
    ...
    public static l a(NetAvailableEvent netAvailableEvent, String str) {
        l lVar = new l();
        lVar.f446a = "mistat_net_event";
        lVar.f447b = "mistat_net_available";
        lVar.f448c = "track";
        lVar.f450e = r.b();
        aj ajVar = new aj();
    ...
    public static l a(String str) {
        ...
        lVar.f446a = isEmpty ? "mistat_signout" : "mistat_signin";
        lVar.f447b = a.h;
        lVar.f448c = "track_signin";
        lVar.f450e = r.b();
        aj ajVar = new aj();
        if (!isEmpty) {
    ...
    private static l a(String str, long j, long j2, boolean z, MiStatParams miStatParams, String str2) {
        l lVar = new l();
        lVar.f446a = "mistat_pa";
        lVar.f447b = z ? a.h : a.i;
        lVar.f448c = "track";
        lVar.f450e = r.b();
    ...
    public static l a(Throwable th, String str, boolean z, String str2) {
        l lVar = new l();
        lVar.f446a = "mistat_app_exception";
        lVar.f447b = a.j;
        lVar.f448c = "track";
        lVar.f450e = r.b();
        aj ajVar = new aj();
    ...
    private static void a(l lVar, String str) {
        if (!TextUtils.isEmpty(str)) {
            lVar.f = str;
            lVar.f449d.putString("mi_sai", str);
        }
    }
}
