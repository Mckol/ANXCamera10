...
public class i {
    ...
    private static final String f525a = "SecretKeyManager";

    /* renamed from: b  reason: collision with root package name */
    private static final String f526b = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCA1ynlvPE46RxIPx6qrb8f20DU\n\rkAJgwHtD3zCEkgOjcvFY2mLl0UGnK1F0Vsh4LvImSCa8o8qYYfBguROgIXRdJGZ+\n\rk9stSV7vWmcsxphMfHEE9R4q+QWqgPBSzwyWmwmAQ7PZmHifOrEYl9t/l0YtmjnW\n\r8Zs3aL7Ap9CGse2kWwIDAQAB\r";

    /* renamed from: c  reason: collision with root package name */
    private static final String f527c = "sid";

    /* renamed from: d  reason: collision with root package name */
    private static final String f528d = "sk";

    /* renamed from: e  reason: collision with root package name */
    private static final String f529e = "rt";
    ...
    private boolean b(boolean z) {
        if (Build.VERSION.SDK_INT < 18) {
            k.b(f525a, "under 4.3,use randomly generated key");
            return false;
        }
        if (j()) {
            k();
        ...
        if (g2 != null) {
            ...
            if (!TextUtils.isEmpty(g2.optString("sk")) && !TextUtils.isEmpty(optString) && !z) {
                k.b(f525a, "key and sid already requested successfully in recent 7 days!");
                return false;
            }
        }
        JSONObject h2 = h();
        long optLong = h2.optLong(f529e);
        int optInt = h2.optInt("rc");
        if (!r.b(optLong) || optInt < 15 || z) {
            return f();
        }
        k.b(f525a, "request count > max count today, skip...");
        return false;
    }
    ...
    private boolean f() {
        ...
        try {
            byte[] a2 = a.a();
            String a3 = d.a(o.a(d.a(f526b), a2));
            i();
            ...
            if (!TextUtils.isEmpty(a4)) {
                ...
                if (optInt == 1 && optJSONObject != null) {
                    ...
                    k.b(f525a, "update secret-key failed: " + optString);
                }
            }
            return true;
        } catch (Exception e4) {
            e2 = e4;
            z = true;
            k.d(f525a, "updateSecretKey e", e2);
            return z;
        }
    }
    ...
    private JSONObject g() {
        ...
        try {
            ...
            k.d(f525a, "decodeFromAndroidKeyStore e", e2);
            return null;
        }
    }
    ...
    private JSONObject h() {
        try {
            ...
            k.d(f525a, "getRequestHistory e", e2);
        }
    ...
    private void i() {
        try {
            ...
            k.b(f525a, "updateSecretKey e", e2);
        }
    }
        ...
        if (com.xiaomi.stat.b.a()) {
            if (com.xiaomi.stat.b.b()) {
                if (l.a()) {
                    ...
                    k.b(f525a, "network not connected!");
                }
                return;
            }
        }
        k.c(f525a, "update abort: statistic or network is not enabled");
    }

    public synchronized byte[] a(byte[] bArr) {
        if (bArr == null) {
            k.b(f525a, "encrypt content is empty");
            return null;
        }
        return a.a(bArr, e());
    }
