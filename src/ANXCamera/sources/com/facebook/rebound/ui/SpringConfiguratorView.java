    ...
    private class SeekbarListener implements SeekBar.OnSeekBarChangeListener {
        ...
        public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
            if (seekBar == SpringConfiguratorView.this.mTensionSeekBar) {
                double d2 = (double) (((((float) i) * 200.0f) / 100000.0f) + 0.0f);
                ...
                TextView textView = SpringConfiguratorView.this.mTensionLabel;
                textView.setText("T:" + format);
            }
            if (seekBar == SpringConfiguratorView.this.mFrictionSeekBar) {
                double d3 = (double) (((((float) i) * 50.0f) / 100000.0f) + 0.0f);
                ...
                TextView textView2 = SpringConfiguratorView.this.mFrictionLabel;
