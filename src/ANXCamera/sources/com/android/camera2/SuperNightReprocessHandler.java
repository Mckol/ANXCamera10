...
public class SuperNightReprocessHandler extends Handler {
    ...
    private MiCamera2ShotRawBurst mCamera2Shot;
    private final MiCamera2 mCameraDevice;
    ...
    public SuperNightReprocessHandler(Looper looper, MiCamera2 miCamera2, int i) {
        ...
        if (i == 0) {
            ...
            i2 = DataRepository.dataItemFeature().Di() ? SuperNightProcess.ARC_SN_CAMERA_MODE_XIAOMI_G90_GW1_INDIA : 1793;
        } else if (i != 1) {
            i2 = 0;
        } else {
            this.superNightRawFormat = SuperNightProcess.ASVL_PAF_RAW10_GRBG_16B;
            i2 = DataRepository.dataItemFeature().Di() ? SuperNightProcess.ARC_SN_CAMERA_MODE_XIAOMI_J15S_G85_S5KGM1_N_INDIA : SuperNightProcess.ARC_SN_CAMERA_MODE_XIAOMI_J15S_G85_S5KGM1_N;
        }
