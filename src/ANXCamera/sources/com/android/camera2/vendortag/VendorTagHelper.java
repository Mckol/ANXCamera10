...
public class VendorTagHelper {
    ...
    private static int getPreferredAction() {
        if (sPreferredAction == -1) {
            sPreferredAction = (Log.isLoggable("VENDOR_TAG_NFE_RETHROW", 3) || !DataRepository.dataItemFeature().Qi()) ? WARNING : RETHROW;
        }
