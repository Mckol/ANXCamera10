                ...
                try {
                    ...
                    try {
                        ...
                        try {
                            ...
                            try {
                                com.android.camera.log.Log.w(TAG, "writeExifByFd: failed to backup the original file", e2);
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        e3 = e5;
                                        try {
                                            com.android.camera.log.Log.w(TAG, "writeExifByFd: failed update exif for " + fileDescriptor, e3);
                                            closeQuietly(fileInputStream3);
                                            closeQuietly(fileOutputStream);
                    ...
                    com.android.camera.log.Log.w(TAG, "writeExifByFd: failed to update exif for " + fileDescriptor, e10);
                }
            } catch (IOException e11) {
                com.android.camera.log.Log.w(TAG, "writeExifByFilePath: failed to extract exif fd " + fileDescriptor, e11);
            }
        }
    }
