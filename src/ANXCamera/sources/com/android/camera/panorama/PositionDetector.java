...
public class PositionDetector {
    ...
    private void updateFrame() {
        ...
        if (this.mPreviewFrameRect.width() > 0) {
            ...
            if (i == 90) {
                f = ((float) this.mPreviewViewWidth) / ((float) this.output_width);
                f2 = (float) this.cur_x;
                height = (float) ((this.cur_y / ((double) this.output_height)) * ((double) this.mPreviewFrameRect.height()));
                f3 = (((float) this.mInitParam.input_height) / 2.0f) * f;
                height2 = this.mPreviewFrameRect.height();
            } else if (i == 180) {
                f = ((float) this.mPreviewViewWidth) / ((float) this.output_height);
                height = (float) ((this.cur_x / ((double) this.output_width)) * ((double) this.mPreviewFrameRect.height()));
                f2 = (float) this.cur_y;
                f3 = (((float) this.mInitParam.input_height) / 2.0f) * f;
                height2 = this.mPreviewFrameRect.height();
            } else if (i == 270) {
                int i2 = this.output_width;
                f = ((float) this.mPreviewViewWidth) / ((float) i2);
