...
public class LightingConstant {
    ...
    public static final String LIGHTING_2_BRIGHT_RED = "16";
    public static final String LIGHTING_2_DAZZLING = "14";
    public static final String LIGHTING_2_DREAMLAND = "17";
    public static final String LIGHTING_2_GORGEOUS = "15";
    public static final String LIGHTING_2_LANSHAN = "13";
    public static final String LIGHTING_2_NEON = "9";
    public static final String LIGHTING_2_NOSTALGIA = "11";
    public static final String LIGHTING_2_PHANTOM = "10";
    public static final String LIGHTING_2_RAINBOW = "12";
