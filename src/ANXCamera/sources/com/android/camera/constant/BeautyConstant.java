...
public class BeautyConstant {
    ...
    public static final String[] BEAUTY_CATEGORY_FRONT_SUPER_NIGHT = {"pref_beautify_skin_smooth_ratio_key", "pref_beautify_slim_face_ratio_key", "pref_beautify_enlarge_eye_ratio_key"};
    ...
    public static final String[] BEAUTY_CATEGORY_MI_LIVE = {"pref_beautify_slim_face_ratio_key", "pref_beautify_enlarge_eye_ratio_key"};
