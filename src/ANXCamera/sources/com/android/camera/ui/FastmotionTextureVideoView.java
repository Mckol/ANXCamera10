...
public class FastmotionTextureVideoView extends TextureView implements TextureView.SurfaceTextureListener, Handler.Callback, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnBufferingUpdateListener {
    ...
    private void openVideo() {
        ...
        } else if ("android.resource".equals(this.mUri.getScheme()) || this.mUri.getPath() == null || new File(this.mUri.getPath()).exists()) {
            release(false);
            try {
                ...
                if (this.attrBuilder == null) {
                    this.attrBuilder = new AudioAttributes.Builder();
                ...
                if (this.mIsNeedAudio) {
                    ...
                    if (this.mediaExtractor == null) {
                        ...
                        this.mediaExtractor.setDataSource(this.mContext, this.mUri, (Map<String, String>) null);
                    }
                    this.mHasAudio = false;
                    for (int i = 0; i < this.mediaExtractor.getTrackCount(); i++) {
                        if (this.mediaExtractor.getTrackFormat(i).getString("mime").startsWith("audio/")) {
                            this.mHasAudio = true;
                            return;
                        }
                    }
                ...
                if (this.mMediaPlayerCallback != null) {
                    this.mHandler.post(new Runnable() {
                        /* class com.android.camera.ui.FastmotionTextureVideoView.AnonymousClass1 */
    ...
    public void onBufferingUpdate(final MediaPlayer mediaPlayer, final int i) {
        if (this.mMediaPlayerCallback != null) {
            this.mHandler.post(new Runnable() {
                /* class com.android.camera.ui.FastmotionTextureVideoView.AnonymousClass7 */
    ...
    public void onCompletion(final MediaPlayer mediaPlayer) {
        ...
        if (this.mMediaPlayerCallback != null) {
            this.mHandler.post(new Runnable() {
                /* class com.android.camera.ui.FastmotionTextureVideoView.AnonymousClass3 */
    ...
    public boolean onError(final MediaPlayer mediaPlayer, final int i, final int i2) {
        ...
        this.mHandler.post(new Runnable() {
            /* class com.android.camera.ui.FastmotionTextureVideoView.AnonymousClass4 */
    ...
    public boolean onInfo(final MediaPlayer mediaPlayer, final int i, final int i2) {
        ...
        this.mHandler.post(new Runnable() {
            /* class com.android.camera.ui.FastmotionTextureVideoView.AnonymousClass8 */
    ...
    public void onPrepared(final MediaPlayer mediaPlayer) {
        if (this.mTargetState == 1 && this.mCurrentState == 1) {
            ...
            if (this.mMediaPlayerCallback != null) {
                this.mHandler.post(new Runnable() {
                    /* class com.android.camera.ui.FastmotionTextureVideoView.AnonymousClass5 */
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        if (this.mMediaPlayerCallback != null) {
            this.mHandler.post(new Runnable() {
                /* class com.android.camera.ui.FastmotionTextureVideoView.AnonymousClass2 */
    ...
    public void onVideoSizeChanged(MediaPlayer mediaPlayer, final int i, final int i2) {
        if (this.mMediaPlayerCallback != null) {
            this.mHandler.post(new Runnable() {
                /* class com.android.camera.ui.FastmotionTextureVideoView.AnonymousClass6 */

                public void run() {
                    int i;
                    int i2 = i;
                    if (i2 != 0 && (i = i2) != 0) {
                        FastmotionTextureVideoView.this.setVideoSpecifiedSize(i2, i);
                    }
                }
            });
        }
