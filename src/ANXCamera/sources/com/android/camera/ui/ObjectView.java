...
public class ObjectView extends FrameView {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mPause || ((i = this.mZoomAnimState) != 0 && (i != 5 || this.mFace == null))) {
            super.onDraw(canvas);
            return;
        }
        canvas.save();
            ...
            if (i == 3) {
                ...
                if (cameraHardwareFace.score < 1) {
                    if (this.mLostTrackThreshold == 0) {
                        ...
                        int i2 = NEAR_EDGE;
                        if (f2 < ((float) i2) || rectF.top - rectF2.top < ((float) i2) || rectF2.right - rectF.right < ((float) i2) || rectF2.bottom - rectF.bottom < ((float) i2)) {
