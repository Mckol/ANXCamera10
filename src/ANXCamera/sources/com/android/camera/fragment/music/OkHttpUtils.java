    ...
    public static void downloadMp3Async(final LiveMusicInfo liveMusicInfo, final String str, final LiveMusicActivity.Mp3DownloadCallback mp3DownloadCallback) {
        new OkHttpClient.Builder().connectTimeout(5, TimeUnit.SECONDS).writeTimeout(5, TimeUnit.SECONDS).readTimeout(5, TimeUnit.SECONDS).build().newCall(new Request.Builder().url(liveMusicInfo.mPlayUrl).build()).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException iOException) {
                String str = OkHttpUtils.TAG;
                Log.e(str, "download mp3 async failed with exception " + iOException.getMessage());
            ...
            public void onResponse(Call call, Response response) {
                ...
                try {
                    ...
                    String str = OkHttpUtils.TAG;
                    Log.e(str, "download mp3 async failed with exception " + e2.getMessage());
