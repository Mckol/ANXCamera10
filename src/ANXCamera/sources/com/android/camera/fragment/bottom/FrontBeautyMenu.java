...
public class FrontBeautyMenu extends AbBottomMenu implements View.OnClickListener {
    ...
    private boolean isJustBeautyTab() {
        int currentMode;
        return DataRepository.dataItemFeature().yi() || (currentMode = ((DataItemGlobal) DataRepository.provider().dataGlobal()).getCurrentMode()) == 162 || currentMode == 161 || currentMode == 174 || currentMode == 183 || currentMode == 171 || currentMode == 176;
    }
