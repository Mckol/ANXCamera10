...
public class GoogleLensFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        return new AlertDialog.Builder(getActivity()).setTitle(R.string.pref_camera_long_press_viewfinder_title).setItems(R.array.dialog_camera_long_press_viewfinder_options, new j(this)).setNegativeButton(17039360, (DialogInterface.OnClickListener) null).create();
    }
}
