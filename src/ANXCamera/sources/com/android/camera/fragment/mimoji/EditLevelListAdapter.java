...
public class EditLevelListAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    private static final String TAG = "EditLevelListAdapter";
    ...
    private AvatarConfigItemClick mAvatarConfigItemClick = new AvatarConfigItemClick() {
        ...
        public void onConfigItemClick(AvatarConfig.ASAvatarConfigInfo aSAvatarConfigInfo, boolean z, int i) {
            ...
            String str = EditLevelListAdapter.TAG;
            Log.d(str, "onConfigItemClick, ASAvatarConfigInfo = " + aSAvatarConfigInfo);
    ...
    public /* synthetic */ void a(MimojiThumbnailRecyclerAdapter mimojiThumbnailRecyclerAdapter, int i, AvatarConfig.ASAvatarConfigInfo aSAvatarConfigInfo, int i2, View view) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        if (i < this.mMimojiThumbnailAdapters.size()) {
            ...
            recyclerView.setVisibility(0);
            MimojiThumbnailRecyclerAdapter mimojiThumbnailRecyclerAdapter = this.mMimojiThumbnailAdapters.get(i);
            ...
            mimojiThumbnailRecyclerAdapter.setOnRecyclerItemClickListener(new a(this, mimojiThumbnailRecyclerAdapter, i));
            return;
        }
        recyclerView.setVisibility(8);
    }
