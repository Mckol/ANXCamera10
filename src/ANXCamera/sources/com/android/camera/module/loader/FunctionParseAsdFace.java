...
public class FunctionParseAsdFace implements Function<CaptureResult, CaptureResult> {
    private static final String TAG = "FunctionParseAsdFace";
    ...
    public CaptureResult apply(CaptureResult captureResult) throws Exception {
        ...
        if (this.mNeedFaceInfo && isUseFaceInfo && faceArr.length > 0) {
            ...
            if (faceAnalyzeInfo.mAge != null) {
                ...
                String str = TAG;
                Log.c(str, "camera faces size:" + cameraHardwareFaceArr.length);
                return captureResult;
            }
        }
        ...
        faceDetectionCallback.onFaceDetected(cameraHardwareFaceArr, this.mFaceInfo, (Rect) captureResult.getRequest().get(CaptureRequest.SCALER_CROP_REGION));
        String str2 = TAG;
        Log.c(str2, "camera faces size:" + cameraHardwareFaceArr.length);
        return captureResult;
    }
}
