...
public class WideSelfieModule extends BaseModule implements ModeProtocol.CameraAction, Camera2Proxy.CameraPreviewCallback, WideSelfieEngineWrapper.WideSelfStateCallback, Camera2Proxy.FaceDetectionCallback {
        ...
        public void handleMessage(Message message) {
            ...
            if (!WideSelfieModule.this.isCreated()) {
                ...
                if (i == 2) {
                    ...
                    WideSelfieEngineWrapper wideSelfieEngineWrapper = WideSelfieModule.this.mWideSelfEngine;
                    ...
                    wideSelfieEngineWrapper.setCameraParameter("1", i2, i3, cameraSize3.width, cameraSize3.height);
                } else if (i == 10) {
    ...
    public static class SaveOutputImageTask extends AsyncTask<Void, Integer, Integer> {
        ...
        public Integer doInBackground(Void... voidArr) {
            ...
            if (i2 > 0 || i > 0) {
                int i3 = DataRepository.dataItemFeature().Ei() ? 2 : Util.isGlobalVersion() ? 0 : 1;
                long currentTimeMillis = System.currentTimeMillis();
    ...
    private void startSaveTask(byte[] bArr, int i, int i2, int i3) {
        ...
        this.mSaveOutputImageTask = new SaveOutputImageTask(this.mActivity, DateFormat.format(this.mFileNameTemplate, System.currentTimeMillis()).toString(), bArr2, i5, i4, z, this.mJpegRotation, this.mActualCameraId, this.mTriggerMode, this.mBeautyValues, this.mStopCaptureMode, new SaveStateCallback() {
    ...
    private void updatePictureAndPreviewSize() {
        PictureSizeManager.initialize(this.mCameraCapabilities.getSupportedOutputSizeWithAssignedMode(35), DataRepository.dataItemFeature().di(), 176, this.mBogusCameraId);
