...
public class LiveConfigChangeTTImpl implements ModeProtocol.LiveConfigChanges {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void updateRecordingTime(long j, float f) {
    ...
    public void initResource() {
        ...
        this.mAuthResult = VERuntime.activate(this.mContext, DataRepository.dataItemFeature().Nk(), DataRepository.dataItemFeature().Mk(), DataRepository.dataItemLive().getActivation());
        TEOAuthResult tEOAuthResult = this.mAuthResult;
        ...
        AnonymousClass1 r0 = new TERecorder.IRenderCallback() {
            ...
            public boolean onDestroy() {
                ...
                try {
                    ...
                    String str = LiveConfigChangeTTImpl.TAG;
                    Log.e(str, "detachFromGLContext exception " + e2.getMessage());
                }
        ...
        this.mRecorder.setNativeInitListener(new VEListener.VERecorderNativeInitListener() {
            ...
            public void onNativeInit(int i, String str) {
                ...
                if (tERecorder != null) {
                    ...
                    String str2 = LiveConfigChangeTTImpl.TAG;
                    Log.e(str2, "slam config result = " + slamDeviceConfig);
    ...
    public void updateRecordingTime() {
        if (this.mMediaRecorderRecording) {
            ...
            this.mCountDownTimer = new CountDownTimer((long) (((float) (((long) this.mMaxVideoDurationInMs) - this.mTotalRecordingTime)) * f), (long) (f * 1000.0f)) {
