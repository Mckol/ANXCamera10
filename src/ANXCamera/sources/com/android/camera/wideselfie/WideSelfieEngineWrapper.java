...
public class WideSelfieEngineWrapper {
    ...
    private int mStitchResult = 0;
    private int mThumbBgWidth;
    private WeakReference<WideSelfStateCallback> mWideSelfCallbackRef;
    ...
    private void handleProcessCallback(int i, ProcessResult processResult) {
