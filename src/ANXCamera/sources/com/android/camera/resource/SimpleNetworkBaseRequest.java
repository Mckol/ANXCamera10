...
public abstract class SimpleNetworkBaseRequest<T> extends BaseObservableRequest<T> {
    ...
    /* access modifiers changed from: protected */
    public abstract T process(String str, @Nullable T t) throws BaseRequestException;

    /* access modifiers changed from: protected */
    @Override // com.android.camera.resource.BaseObservableRequest
    public void scheduleRequest(final ResponseListener<T> responseListener, @NonNull final T t) {
        ...
        CLIENT.newCall(generatePostBody == null ? url.build() : url.post(generatePostBody).build()).enqueue(new Callback() {
            ...
            /* JADX DEBUG: Multi-variable search result rejected for r0v3, resolved type: com.android.camera.resource.SimpleNetworkBaseRequest */
            /* JADX DEBUG: Multi-variable search result rejected for r0v5, resolved type: com.android.camera.resource.ResponseListener */
