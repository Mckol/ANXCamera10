    ...
    private void updateASDScene(MarshalQueryableASDScene.ASDScene aSDScene) {
        ...
        if (i == 4) {
            ...
            if (baseModule != null) {
                ...
                } else if (baseModule instanceof AmbilightModule) {
                    AmbilightModule ambilightModule = (AmbilightModule) baseModule;
                    ambilightModule.setAsdScenes(aSDSceneArr);
                    ambilightModule.updatePreferenceInWorkThread(59);
                }
            }
        }
    }
