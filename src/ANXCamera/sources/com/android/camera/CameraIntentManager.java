...
public class CameraIntentManager {
    ...
    public int getCameraModeId() {
        ...
        switch (c2) {
            ...
            case 6:
                return 165;
            case 7:
                if (DataRepository.dataItemFeature().Kj()) {
                    return 174;
                }
                return DataRepository.dataItemFeature().Rj() ? 183 : 161;
            case '\b':
                return 162;
            case '\t':
                return 169;
            case '\n':
                return DataRepository.dataItemFeature().wm() ? 172 : 160;
            case 11:
                return 173;
            case '\f':
                return 175;
    ...
    public Boolean isFromVolumeKey() {
        ...
        String str = TAG;
        Log.d(str, "camera_launch_source = " + stringExtra);
