...
public class ComponentSettingMultipleCommon extends ComponentMultiple {
    ...
    public void initTypeElements(Context context, int i, CameraCapabilities cameraCapabilities, int i2) {
        ...
        insert(new TypeItem((int) R.string.pref_camera_recordlocation_title, string, CameraSettings.KEY_RECORD_LOCATION, Boolean.TRUE), new TypeItem((int) R.string.pref_camera_sound_title, string, CameraSettings.KEY_CAMERA_SOUND, Boolean.TRUE));
    }
}
