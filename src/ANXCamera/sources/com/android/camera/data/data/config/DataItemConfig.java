...
public class DataItemConfig extends DataItemBase {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x0066, code lost:
        if (r3.equals(r0) == false) goto L_0x008d;
     */
    ...
    public boolean reConfigHhrIfFlashChanged(int i, String str, String str2) {
        ...
        String str3 = "off";
        if ("3".equals(str2) || ComponentConfigFlash.FLASH_VALUE_SCREEN_LIGHT_AUTO.equals(str2)) {
        ...
        } else if (!"1".equals(str2) && !ComponentConfigFlash.FLASH_VALUE_SCREEN_LIGHT_ON.equals(str2)) {
            if ("2".equals(str2) || "5".equals(str2)) {
                if (!"live".equals(persistValue)) {
                }
            } else if ("0".equals(str2) && ("1".equals(str) || "2".equals(str))) {
                str3 = getComponentHdr().getDefaultValue(i);
                if (str3 != null) {
                }
                return false;
            }
