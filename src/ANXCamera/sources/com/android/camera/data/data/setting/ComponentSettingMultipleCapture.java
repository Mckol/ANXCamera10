...
public class ComponentSettingMultipleCapture extends ComponentMultiple {
    ...
    public void initTypeElements(Context context, int i, CameraCapabilities cameraCapabilities, int i2) {
        TypeItem typeItem = new TypeItem((int) R.string.pref_camera_jpegquality_title, context.getString(getDisplayTitleString()), CameraSettings.KEY_JPEG_QUALITY, context.getString(R.string.pref_camera_jpegquality_default));
