...
public class CameraStatUtils {
    ...
    private static HashMap<String, String> sMiLiveBeautyTypeToName = new HashMap<>();
    ...
    private static void addUltraPixelParameter(Map<String, String> map) {
        ...
        } else if (DataRepository.dataItemFeature().Eh() == 0) {
            if (isUltraPixelOn) {
    ...
    public static void trackAmbilightCapture(int i, long j) {
        if (!MistatsWrapper.isCounterEventDisabled()) {
            HashMap hashMap = new HashMap();
    ...
    public static void trackDualVideo(String str, String str2) {
        HashMap hashMap = new HashMap();
    ...
    public static void trackGeneralInfo(Map map, boolean z, boolean z2, int i, int i2, boolean z3, int i3, BeautyValues beautyValues, MutexModeManager mutexModeManager, String str) {
        ...
        String str3 = "null";
        hashMap.put(MistatsConstants.Setting.PARAM_SAVE_LOCATION, z2 ? MistatsConstants.BaseEvent.VALUE_NOT_NULL : CameraSettings.isRecordLocation() ? str3 : "close");
        ...
        hashMap.put(MistatsConstants.BaseEvent.PARAM_PICTURE_RATIO, DataRepository.dataItemConfig().getComponentConfigRatio().getComponentValue(i));
        addUltraPixelParameter(z3, hashMap);
        hashMap.put(MistatsConstants.BaseEvent.QUALITY, CameraSettings.getEncodingQuality(z).name().toLowerCase(Locale.ENGLISH));
        if (z3) {
        ...
        if (!z && mutexModeManager != null) {
            ...
            if (componentHdr != null && "auto".equals(componentHdr.getComponentValue(i))) {
                ...
                if (dataItemRunning != null) {
                    if (dataItemRunning.getComponentRunningColorEnhance().isEnabled(i)) {
                        hashMap.put(MistatsConstants.ProColor.CAPTURE_STATE, MistatsConstants.ProColor.VALUE_ON);
                    } else {
                        hashMap.put(MistatsConstants.ProColor.CAPTURE_STATE, MistatsConstants.ProColor.VALUE_OFF);
                    }
                }
    ...
    public static void trackMiLiveRecordingParams(int i, String str, int i2, int i3, boolean z, BeautyValues beautyValues, int i4, String str2) {
        if (!MistatsWrapper.isCounterEventDisabled()) {
            ...
            String str4 = sMiLiveBeautyTypeToName.get("pref_beautify_skin_smooth_ratio_key");
            if (str4 != null) {
                hashMap.put(str4, faceBeautyRatioToName(beautyValues.getValueByType("pref_beautify_skin_smooth_ratio_key")));
            }
            int i5 = 0;
            if (z) {
                ...
                while (i5 < length) {
                    ...
                    String str6 = sMiLiveBeautyTypeToName.get(str5);
                    if (str6 != null) {
                        hashMap.put(str6, faceBeautyRatioToName(beautyValues.getValueByType(str5)));
                    }
                    i5++;
                ...
                while (i5 < length2) {
                    ...
                    String str8 = sMiLiveBeautyTypeToName.get(str7);
                    if (str8 != null) {
                        hashMap.put(str8, faceBeautyRatioToName(beautyValues.getValueByType(str7)));
                    }
                    i5++;
    ...
    public static void trackMultiCameraDualVideo(String str, String str2, String str3, String str4, int i, int i2) {
        HashMap hashMap = new HashMap();
        hashMap.put(MistatsConstants.DualVideoAttr.ATTR_COMPOSE_TYPE, str);
        hashMap.put("attr_video_duration", str2);
        hashMap.put(MistatsConstants.MultiCameraAttr.ATTR_DEVICE_TYPE, str3);
        hashMap.put(MistatsConstants.MultiCameraAttr.ATTR_RECORD_TYPE, str4);
        hashMap.put(MistatsConstants.MultiCameraAttr.ATTR_RECORD_PAUSED, String.valueOf(i));
        hashMap.put(MistatsConstants.MultiCameraAttr.ATTR_RECORD_CAPTURE, String.valueOf(i2));
    ...
    public static void trackSuperNightInCaptureMode(Map map, boolean z) {
        if (DataRepository.dataItemFeature().nk()) {
            if (map == null) {
                map = new HashMap();
            }
    ...
    public static void trackTimerBurst(int i, float f, int i2) {
        HashMap hashMap = new HashMap();
    ...
    public static void trackVideoRecorded(boolean z, int i, int i2, boolean z2, boolean z3, boolean z4, String str, int i3, int i4, int i5, int i6, BeautyValues beautyValues, long j, boolean z5) {
        ...
        if (i2 == 180 || i2 == 162) {
            hashMap.put(MistatsConstants.VideoAttr.PARAM_CINEMATIC_RATIO, CameraSettings.isCinematicAspectRatioEnabled(i2) ? "on" : str2);
        ...
        if (i6 > 0 && CameraSettings.VIDEO_SPEED_FAST.equals(str)) {
            ...
            if (DataRepository.dataItemFeature().uj()) {
                ...
                hashMap2.put(MistatsConstants.Zoom.PARAM_SAT_ZOOM_RATIO, String.valueOf(HybridZoomingSystem.toDecimal(CameraSettings.readZoom())));
                hashMap2.put("attr_filter", String.valueOf(CameraSettings.getShaderEffect()));
                if (CameraSettings.isCinematicAspectRatioEnabled(i2)) {
                    str2 = "on";
                }
                hashMap2.put(MistatsConstants.VideoAttr.PARAM_CINEMATIC_RATIO, str2);
            }
