...
public class SaveTaskDao extends AbstractDao<SaveTask, Long> {
    ...
    public static class Properties {
        ...
        public static final Property NoGaussian = new Property(7, Integer.TYPE, "noGaussian", false, ProcessingMetadataQuery.NO_GAUSSIAN);
    ...
    public static void createTable(Database database, boolean z) {
        ...
        database.execSQL("CREATE TABLE " + str + "\"tasks\" (\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE ,\"start_time\" INTEGER,\"media_store_id\" INTEGER,\"media_path\" TEXT,\"progress_status\" INTEGER NOT NULL ,\"progress_percentage\" INTEGER NOT NULL ,\"jpeg_rotation\" INTEGER NOT NULL ,\"no_gaussian\" INTEGER NOT NULL );");
    }
    ...
    public SaveTask readEntity(Cursor cursor, int i) {
        ...
        int i5 = i + 3;
        return new SaveTask(valueOf, valueOf2, valueOf3, cursor.isNull(i5) ? null : cursor.getString(i5), cursor.getInt(i + 4), cursor.getInt(i + 5), cursor.getInt(i + 6), cursor.getInt(i + 7));
    }
