...
public class DrawJPEGAttribute extends DrawAttribute {
    ...
    public DrawJPEGAttribute(byte[] bArr, boolean z, int i, int i2, int i3, int i4, int i5, EffectController.EffectRectAttribute effectRectAttribute, Location location, String str, long j, int i6, int i7, float f, boolean z2, String str2, boolean z3, PictureInfo pictureInfo, List<WaterMarkData> list, boolean z4, boolean z5, String str3, boolean z6, int i8, int i9, boolean z7) {
