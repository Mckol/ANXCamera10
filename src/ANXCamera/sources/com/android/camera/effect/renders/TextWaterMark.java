...
class TextWaterMark extends WaterMark {
    ...
    private final int[][] PIC_WIDTHS = {new int[]{0, 149}, new int[]{150, 239}, new int[]{240, 279}, new int[]{280, SearchActionModeViewHelper.ANIMATION_DURATION}, new int[]{401, 1439}, new int[]{1440, 1511}, new int[]{1512, 1799}, new int[]{1800, 1899}, new int[]{1900, 2299}, new int[]{2300, 3120}, new int[]{3121, 4000}};
