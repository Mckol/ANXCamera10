...
public class SnapshotEffectRender {
    ...
    public class EGLHandler extends Handler {
        ...
        private byte[] applyEffect(DrawJPEGAttribute drawJPEGAttribute, int i, boolean z, Size size, Size size2) {
            ...
            if (thumbnailBytes == null) {
                ...
                if (drawJPEGAttribute.mApplyWaterMark) {
                    if (!z) {
                        int[] watermarkRange = Util.getWatermarkRange(i5, i2, (drawJPEGAttribute.mJpegOrientation + 270) % 360, drawJPEGAttribute.mDeviceWaterMarkEnabled, drawJPEGAttribute.mTimeWaterMarkText != null, drawJPEGAttribute.isMiMovieOpen);
                        z2 = false;
                        i9 = i3;
                        i8 = 1;
                        i7 = i4;
                    ...
                    if (!DataRepository.dataItemFeature().xl() || (pictureInfo = drawJPEGAttribute.mInfo) == null || !pictureInfo.isFrontCamera()) {
                ...
                int i15 = SnapshotEffectRender.this.mQuality;
                if (z) {
                    i15 = Math.min(SnapshotEffectRender.this.mQuality, EncodingQuality.NORMAL.toInteger(z2));
                }
                if (drawJPEGAttribute.isMiMovieOpen && !z) {
                    eGLHandler.drawBlackBridge(size2.width, size2.height);
                }
                byte[] picture = ShaderNativeUtil.getPicture(i9, i7, i6, i2, i15);
                ...
                char c5 = z2 ? 1 : 0;
                char c6 = z2 ? 1 : 0;
                if (GLES20.glIsTexture(iArr3[c2])) {
                    int i16 = z2 ? 1 : 0;
                    int i17 = z2 ? 1 : 0;
                    int i18 = z2 ? 1 : 0;
                    int i19 = z2 ? 1 : 0;
                    int i20 = z2 ? 1 : 0;
                    GLES20.glDeleteTextures(i8, iArr3, i16);
                }
        ...
        /* JADX WARNING: Removed duplicated region for block: B:33:0x01e4  */
        /* JADX WARNING: Removed duplicated region for block: B:37:0x01fb  */
        /* JADX WARNING: Removed duplicated region for block: B:52:0x0489  */
        /* JADX WARNING: Removed duplicated region for block: B:55:0x049e  */
        /* JADX WARNING: Removed duplicated region for block: B:58:0x04bf  */
        ...
        private void blockSplitApplyEffect(DrawJPEGAttribute drawJPEGAttribute, int i, boolean z, Size size, Size size2) {
            ...
            if (drawJPEGAttribute2.mRequestModuleIdx != 165) {
                ...
                if (!drawJPEGAttribute2.mApplyWaterMark) {
                    i6 = i3;
                    int[] watermarkRange = Util.getWatermarkRange(drawJPEGAttribute2.mWidth, drawJPEGAttribute2.mHeight, (drawJPEGAttribute2.mJpegOrientation + 270) % 360, drawJPEGAttribute2.mDeviceWaterMarkEnabled, drawJPEGAttribute2.mTimeWaterMarkText != null, drawJPEGAttribute2.isMiMovieOpen);
                    i7 = i2;
                ...
                while (i8 < split.size()) {
                    ...
                    if (drawJPEGAttribute2.mApplyWaterMark && rectangle_collision(rectF3.left, rectF3.top, rectF3.width(), rectF3.height(), rectF.left, rectF.top, rectF.width(), rectF.height())) {
                        ...
                        if (!DataRepository.dataItemFeature().xl() || (pictureInfo = drawJPEGAttribute2.mInfo) == null || !pictureInfo.isFrontCamera()) {
        ...
        private WaterMark drawDoubleShotWaterMark(DrawJPEGAttribute drawJPEGAttribute, int i, int i2, int i3, int i4, int i5, WaterMark waterMark) {
            ...
            if (waterMark != null) {
                ...
                if (!drawJPEGAttribute.isMiMovieOpen || !((i6 = drawJPEGAttribute.mJpegOrientation) == 90 || i6 == 270)) {
                    ...
                    ImageWaterMark imageWaterMark = new ImageWaterMark(bitmap, i3, i4, i5, SnapshotEffectRender.this.mDualCameraWaterMarkSizeRatio, SnapshotEffectRender.this.mDualCameraWaterMarkPaddingXRatio, SnapshotEffectRender.this.mDualCameraWaterMarkPaddingYRatio, drawJPEGAttribute.isMiMovieOpen);
                ...
                if (SnapshotEffectRender.this.mCinematicRatioWaterMarkBitmap == null) {
                    ...
                    snapshotEffectRender3.mCinematicRatioWaterMarkBitmap = snapshotEffectRender3.loadCinematicRatioWatermark(snapshotEffectRender3.mContext);
                }
                if (SnapshotEffectRender.this.mCinematicRatioWaterMarkBitmap != null) {
        ...
        private WaterMark drawTimeWaterMark(DrawJPEGAttribute drawJPEGAttribute, int i, int i2, int i3, int i4, int i5, WaterMark waterMark) {
            ...
            WaterMark newStyleTextWaterMark = c.Pn() ? new NewStyleTextWaterMark(str, i3, i4, i5, drawJPEGAttribute.isMiMovieOpen) : new TextWaterMark(str, i3, i4, i5);
        ...
        private boolean saveMainJpeg(DrawJPEGAttribute drawJPEGAttribute, boolean z, boolean z2, byte[] bArr) {
            ...
            if (z) {
                ...
                if (SnapshotEffectRender.this.mImageSaver != null) {
                    ImageSaver imageSaver = SnapshotEffectRender.this.mImageSaver;
                    ...
                    String str5 = SnapshotEffectRender.TAG;
                    Log.d(str5, "updateImage: uri=" + drawJPEGAttribute.mUri);
                    Context context2 = SnapshotEffectRender.this.mContext;
                    byte[] bArr3 = drawJPEGAttribute.mData;
                    ExifInterface exifInterface = drawJPEGAttribute.mExif;
                    Uri uri = drawJPEGAttribute.mUri;
                    String str6 = str == null ? drawJPEGAttribute.mTitle : str;
                    ...
                    Storage.updateImage(context2, bArr3, false, exifInterface, uri, str6, location, i, i2, i3, str3);
                    return true;
                }
        ...
        public void drawBlackBridge(int i, int i2) {
            ...
            if (i < i2) {
                ...
                SnapshotEffectRender.this.mGLCanvas.getBasicRender().draw(new FillRectAttribute(((float) i) - cinematicAspectRatio, 0.0f, cinematicAspectRatio, f, ViewCompat.MEASURED_STATE_MASK));
            } else {
                ...
                SnapshotEffectRender.this.mGLCanvas.getBasicRender().draw(new FillRectAttribute(0.0f, ((float) i2) - cinematicAspectRatio2, f2, cinematicAspectRatio2, ViewCompat.MEASURED_STATE_MASK));
            }
            SnapshotEffectRender.this.mGLCanvas.getState().popState();
        }
            ...
            if (SnapshotEffectRender.this.mSaverCallback.get() != null) {
                ...
                switch (message.what) {
                    ...
                    case 2:
                        ...
                        int i2 = SnapshotEffectRender.this.mBlockWidth;
                        int i3 = SnapshotEffectRender.this.mBlockHeight;
                        int calEachBlockHeight = SnapshotEffectRender.this.calEachBlockHeight(drawJPEGAttribute2.mWidth, drawJPEGAttribute2.mHeight);
                        int i4 = drawJPEGAttribute2.mWidth;
                        if (i4 == 0 || drawJPEGAttribute2.mHeight == 0) {
                        ...
                        SnapshotEffectRender.this.mBlockWidth = i4;
                        SnapshotEffectRender.this.mBlockHeight = drawJPEGAttribute2.mHeight / calEachBlockHeight;
                        SnapshotEffectRender.this.mRenderSurface.makeCurrent();
                        ...
                        while (SnapshotEffectRender.this.mBlockWidth > allocate.get(0)) {
                            SnapshotEffectRender.this.mBlockWidth = i5 / 2;
                        }
                        if (!(i2 == SnapshotEffectRender.this.mBlockWidth && i3 == SnapshotEffectRender.this.mBlockHeight) && SnapshotEffectRender.this.mInitGraphicBuffer) {
                            SnapshotEffectRender.this.mRenderSurface.makeCurrent();
    ...
    public SnapshotEffectRender(ImageSaver.ImageSaverCallback imageSaverCallback, boolean z) {
        ...
        if (DataRepository.dataItemFeature().xl()) {
