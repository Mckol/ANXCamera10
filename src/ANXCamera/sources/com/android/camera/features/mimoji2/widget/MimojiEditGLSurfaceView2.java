...
public class MimojiEditGLSurfaceView2 extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    private static final String TAG = "MimojiEditGLSurfaceView2";
    ...
    public void onDrawFrame(GL10 gl10) {
        ...
        if (!this.mIsStopRender) {
            ...
            if (this.mSaveConfigThum) {
                ...
                AvatarEngineManager2.getInstance().queryAvatar().renderThumb(244, 292, 21, 20, bArr, 200, 200, 800, BACKGROUND_COLOR, 1.0f);
