...
public class BaseItemAnimator extends DefaultItemAnimator {
    ...
    private void animateRemoveImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        animate.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new AnimatorListenerAdapter() {
            /* class com.android.camera.features.mimoji2.widget.baseview.BaseItemAnimator.AnonymousClass4 */
    ...
    @Override // com.android.camera.fragment.DefaultItemAnimator, androidx.recyclerview.widget.SimpleItemAnimator
    ...
    public void animateAddImpl(final RecyclerView.ViewHolder viewHolder) {
        ...
        animate.alpha(1.0f).setDuration(getAddDuration()).setListener(new AnimatorListenerAdapter() {
            /* class com.android.camera.features.mimoji2.widget.baseview.BaseItemAnimator.AnonymousClass5 */
    ...
    public void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (view2 != null) {
            ...
            duration.alpha(0.0f).setListener(new AnimatorListenerAdapter() {
                /* class com.android.camera.features.mimoji2.widget.baseview.BaseItemAnimator.AnonymousClass7 */
        ...
        if (view != null) {
            ...
            animate.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(1.0f).setListener(new AnimatorListenerAdapter() {
                /* class com.android.camera.features.mimoji2.widget.baseview.BaseItemAnimator.AnonymousClass8 */
    ...
    public void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i, int i2, int i3, int i4) {
        ...
        animate.setDuration(getMoveDuration()).setListener(new AnimatorListenerAdapter() {
            /* class com.android.camera.features.mimoji2.widget.baseview.BaseItemAnimator.AnonymousClass6 */
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.ItemAnimator, com.android.camera.fragment.DefaultItemAnimator
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z2) {
                ...
                AnonymousClass1 r6 = new Runnable() {
                    /* class com.android.camera.features.mimoji2.widget.baseview.BaseItemAnimator.AnonymousClass1 */
            ...
            if (z3) {
                ...
                AnonymousClass2 r62 = new Runnable() {
                    /* class com.android.camera.features.mimoji2.widget.baseview.BaseItemAnimator.AnonymousClass2 */
            ...
            if (z4) {
                ...
                AnonymousClass3 r5 = new Runnable() {
                    /* class com.android.camera.features.mimoji2.widget.baseview.BaseItemAnimator.AnonymousClass3 */
