...
public final class MimojiThumbnailRenderThread2 extends Thread {
    ...
    private static final String TAG = "MimojiThumbnailRenderThread2";
    private AvatarEngine mAvatarForEdit;
    private ConfigInfoThumUtils2 mConfigInfoThumUtils2;
    private Context mContext;
    private AtomicInteger mCountEmotGif = new AtomicInteger();
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void doEmoPicture(ArrayList<EmoInfo> arrayList) {
    ...
    private void doEmoVideo(ArrayList<EmoInfo> arrayList) {
        initEmoticon();
        AvatarEmoManager avatarEmoManager = this.mEmoManager;
        if (avatarEmoManager != null) {
            avatarEmoManager.stopRecording();
            ...
            while (it.hasNext()) {
                ...
                this.mEmoManager.startRecording(str, 0, next.getEmoImageSize().getWidth(), next.getEmoImageSize().getHeight(), 100000000, "video/avc");
                this.mEmoManager.emoProcess(next);
                AvatarEmoManager avatarEmoManager2 = this.mEmoManager;
                if (avatarEmoManager2 == null || avatarEmoManager2.isRelease()) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void doSetConfig(AvatarConfig.ASAvatarConfigInfo aSAvatarConfigInfo) {
    ...
    public void initEmoticon() {
        if (this.mAvatarForEdit != null) {
            ...
            if (avatarEmoManager == null || avatarEmoManager.isRelease()) {
                this.mEmoManager = new AvatarEmoManager(this.mAvatarForEdit, AvatarEngineManager2.TEMPLATE_PATH_GIF, AvatarEngineManager2.getInstance().getASAvatarConfigValue().configFaceColorID, new AvatarEmoManager.AvatarEmoResCallback() {
                    /* class com.android.camera.features.mimoji2.fragment.edit.MimojiThumbnailRenderThread2.AnonymousClass1 */

                    @Override // com.arcsoft.avatar2.emoticon.AvatarEmoManager.AvatarEmoResCallback
                    public void onFrameRefresh(EmoInfo.EmoExtraInfo emoExtraInfo) {
                        String str = MimojiThumbnailRenderThread2.TAG;
                        Log.d(str, "onFrameRefresh emoExtraInfo : " + emoExtraInfo.index);
                    ...
                    public void onMakeMediaEnd() {
                        String str = MimojiThumbnailRenderThread2.TAG;
                        Log.d(str, "onMakeMediaEnd 时间: " + System.currentTimeMillis());
                        if (MimojiThumbnailRenderThread2.this.mEmoManager == null || MimojiThumbnailRenderThread2.this.mEmoManager.isRelease()) {
                            Log.e("release_avatar", "-> for break ---");
                            return;
                        }
