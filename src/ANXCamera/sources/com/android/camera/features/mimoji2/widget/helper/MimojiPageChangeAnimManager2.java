...
public class MimojiPageChangeAnimManager2 {
    ...
    private RelativeLayout.LayoutParams layoutParamsTextureView;
    ...
    public void resetTextureViewPosition(int i) {
        ...
        if (i == 6) {
            ...
            int i4 = this.widthSurfacePixel;
            layoutParams2.width = i4;
            layoutParams2.height = i4;
            this.xCoordinateStartTexture = (this.screenWidth / 2) - (i4 / 2);
    ...
    public void translateYTextureView() {
        ...
        ofFloat.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                RelativeLayout.LayoutParams layoutParams = mimojiPageChangeAnimManager2.layoutParamsTextureView;
                MimojiPageChangeAnimManager2 mimojiPageChangeAnimManager22 = MimojiPageChangeAnimManager2.this;
                layoutParams.topMargin = mimojiPageChangeAnimManager22.mLocationTextureView[1];
