...
public class LensAgent {
    ...
    public static class SingletonHandler {
        private static final LensAgent LENS_AGENT = new LensAgent();
    ...
    public static boolean isConflictAiScene(int i) {
        ...
        return i != 31 ? i == 34 || i == 37 : DataRepository.dataItemFeature().Gl();
    }

    static /* synthetic */ void x(int i) {
    ...
    public void onFocusChange(@LensliteUiController.FocusType int i, float f, float f2) {
        if (this.mInitialized) {
            Log.d(TAG, "onFocusChange: type = " + i + ", " + f + "x" + f2);
            try {
