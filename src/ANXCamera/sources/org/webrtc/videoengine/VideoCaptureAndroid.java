...
public class VideoCaptureAndroid implements Camera.PreviewCallback, SurfaceHolder.Callback {
    ...
    private Integer deviceRotation = 0;
    ...
    private void getCurrentVideoZoomFactorOnCameraThread(Exchanger<Integer> exchanger) {
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void getSupportedVideoZoomMaxFactorOnCameraThread(Exchanger<Integer> exchanger) {
        Camera camera2 = this.camera;
        if (camera2 == null) {
            Log.d(TAG, "Camera is null.");
            exchange(exchanger, 0);
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void isVideoZoomSupportedOnCameraThread(Exchanger<Boolean> exchanger) {
        Camera camera2 = this.camera;
        if (camera2 == null) {
            Log.d(TAG, "Camera is null.");
    ...
    private synchronized void setExposurePointOfInterest(final float f, final float f2) {
        this.cameraThreadHandler.post(new Runnable() {
            /* class org.webrtc.videoengine.VideoCaptureAndroid.AnonymousClass9 */

            public void run() {
                VideoCaptureAndroid.this.setExposurePointOfInterestOnCameraThread(f, f2);
            }
        });
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setExposurePointOfInterestOnCameraThread(float f, float f2) {
        Camera camera2 = this.camera;
        if (camera2 == null) {
            Log.d(TAG, "Camera is null.");
            return;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setFlashStateOnCameraThread(boolean z) {
        Camera camera2 = this.camera;
        if (camera2 == null) {
            Log.d(TAG, "Camera is null.");
            return;
    ...
    private synchronized void setFocusPointOfInterest(final float f, final float f2) {
        this.cameraThreadHandler.post(new Runnable() {
            /* class org.webrtc.videoengine.VideoCaptureAndroid.AnonymousClass4 */

            public void run() {
                VideoCaptureAndroid.this.setFocusPointOfInterestOnCameraThread(f, f2);
            }
        });
    }
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setFocusPointOfInterestOnCameraThread(float f, float f2) {
        Camera camera2 = this.camera;
        if (camera2 == null) {
            Log.d(TAG, "Camera is null.");
            return;
    ...
    /* access modifiers changed from: private */
    /* access modifiers changed from: public */
    private void setVideoZoomFactorOnCameraThread(int i) {
        Camera camera2 = this.camera;
        if (camera2 == null) {
            Log.d(TAG, "Camera is null.");
            return;
    ...
    @SuppressLint({"NewApi"})
    private void startCaptureOnCameraThread(int i, int i2, int i3, int i4, Exchanger<Boolean> exchanger) {
        ...
        try {
            ...
            Log.e(TAG, "startCapture failed", e3);
            if (this.camera != null) {
            }
            exchange(exchanger, false);
